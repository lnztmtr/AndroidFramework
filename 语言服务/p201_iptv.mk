...
BUILD_SY_APKS := true
BUILD_IPANEL_APKS := false
#modified by yzs from false to true
TARGET_NO_USE_SYSWRITE := true
...
ifeq ($(strip $(CHINA_TELECOM_ENABLE)),true)
    ...
    ifeq ($(YSTEN_CUSTOM_PATCH),CM201_guangdong_zy)
	    PRODUCT_COPY_FILES += \
		    device/amlogic/common/init/mbx/init.amlogic_gdzymobile.rc:root/init.amlogic.rc
	else
	    PRODUCT_COPY_FILES += \
