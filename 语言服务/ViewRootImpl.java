...
public final class ViewRootImpl implements ViewParent,
    ...
    final class ViewPostImeInputStage extends InputStage {
        ...
        private int processKeyEvent(QueuedInputEvent q) {
            final KeyEvent event = (KeyEvent)q.mEvent;
	    /*add by zhaolianghua for hebei EPG use systen volume UI @20180104 start*/
	    /*if("cm201_hebei".equals(SystemProperties.get("ro.ysten.province","master"))
			    ...
			    &&"com.android.smart.terminal.iptv".equals(mContext.getPackageName())){
	    ...
	    /*add by zhaolianghua end*/
			...
			//add logs for customer when key is processed by 3rd apk but focus didn't move.added by ww
			if(SystemProperties.getBoolean("debug,key",false)){
				Log.e(TAG,"---Drop key,stop system to find focus!");
				return FINISH_HANDLED;
			}
