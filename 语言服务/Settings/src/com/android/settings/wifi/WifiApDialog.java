...
public class WifiApDialog extends AlertDialog implements View.OnClickListener,
    ...
    public void onClick(View view) {
        ...
        if (((CheckBox) view).isChecked()) {
            Log.e(TAG, "Add samba user");

            try {
            mNwService.addSambaUser(username, username);
            } catch (Exception e) {
                Log.e(TAG, "Error add samba user " + username + ", :" + e);
                return;
            }
        }
        else {
            Log.e(TAG, "Delete samba user");
            try {
            mNwService.deleteSambaUser(username);
            } catch (Exception e) {
                Log.e(TAG, "Error delete samba user " + username + ", :" + e);
                return;
            }
        }
