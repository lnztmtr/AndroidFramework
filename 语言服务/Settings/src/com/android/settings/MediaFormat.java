...
public class MediaFormat extends Activity {
    ...
    private Button mFinalButtonFat;
    private Button mFinalButtonNtfs;
    ...
    private Button.OnClickListener mFinalClickListener_Fat = new Button.OnClickListener() {
            public void onClick(View v) {
                ...
                final StorageVolume storageVolume = getIntent().getParcelableExtra(
                        StorageVolume.EXTRA_STORAGE_VOLUME);
                intent.putExtra(StorageVolume.EXTRA_STORAGE_VOLUME, storageVolume);
                intent.putExtra(StorageVolume.EXTRA_FORMAT_FSTYPE, "fat");
                startService(intent);
                finish();
            }
        };

    private Button.OnClickListener mFinalClickListener_Ntfs = new Button.OnClickListener() {
            public void onClick(View v) {
                ...
                final StorageVolume storageVolume = getIntent().getParcelableExtra(
                        StorageVolume.EXTRA_STORAGE_VOLUME);
                intent.putExtra(StorageVolume.EXTRA_STORAGE_VOLUME, storageVolume);
                intent.putExtra(StorageVolume.EXTRA_FORMAT_FSTYPE, "ntfs");
                startService(intent);
                finish();
            }
        };
    ...
    private void establishFinalConfirmationState() {
        if (mFinalView == null) {
            ...
            mFinalButtonFat =
                    (Button) mFinalView.findViewById(R.id.execute_media_format_fat);
            mFinalButtonFat.setOnClickListener(mFinalClickListener_Fat);

            mFinalButtonNtfs =
                    (Button) mFinalView.findViewById(R.id.execute_media_format_ntfs);
            mFinalButtonNtfs.setOnClickListener(mFinalClickListener_Ntfs);
        }
