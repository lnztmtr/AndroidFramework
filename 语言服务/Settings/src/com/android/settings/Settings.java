...
public class Settings extends PreferenceActivity
    ...
    public boolean dispatchKeyEvent (KeyEvent event){
        if (event.getAction() == KeyEvent.ACTION_DOWN ){
            if (getIntent() != null){
                String currentFragmentName = getIntent().getStringExtra(PreferenceActivity.EXTRA_SHOW_FRAGMENT);
                if (InputMethodAndLanguageSettings.class.getName().equals(currentFragmentName) && getCurrentFocus()!=null){
    ...
    public void onHeaderClick(Header header, int position) {
        ...
        if (header.id == R.id.filemanager) {
            Intent intent = new Intent();
            intent.setComponent(new ComponentName("com.yst.locafilemanager", "com.yst.locafilemanager.activity.MainActivity"));
