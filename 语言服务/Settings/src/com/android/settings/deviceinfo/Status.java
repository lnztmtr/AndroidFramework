...
public class Status extends PreferenceActivity {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        if (Utils.platformHasMbxUiMode()){
        	...
        	removePreferenceFromScreen(KEY_ETHERNET_MAC_ADDRESS);
        ...
        if (UserHandle.myUserId() == UserHandle.USER_OWNER) {
            if (Utils.platformHasMbxUiMode())
                mPhone = null;//PhoneFactory.getDefaultPhone();
            else
    ...
    private void setEthernetStatus() {
        ...
        try {
            ...
            byte[] buf = NetworkInterface.getByName(prop.getInterfaceName()).getHardwareAddress();
