...
extern int register_android_view_AmlScreenShot(JNIEnv* env);
...
extern int register_android_net_vlan_VlanManager(JNIEnv* env);
...
static const RegJNIRec gRegJNI[] = {
    ...
    REG_JNI(register_android_view_AmlScreenShot),
    ...
    REG_JNI(register_android_net_vlan_VlanManager),
