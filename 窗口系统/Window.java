...
public abstract class Window {
    ...
    public void setWindowManager(WindowManager wm, IBinder appToken, String appName,
		...
		//updater with hwz at 2020.04.29  关闭未来电视牌照硬件加速
        if(mAppName != null && (mAppName.contains("com.duolebo.shcmcc.activity.HomeActivity")
                        ...
                        || mAppName.contains("tv.icntv.ott.icntv"))){
		mHardwareAccelerated = false;
		android.util.Log.e("Window","remove HardwareAccelerated for "+mAppName);
        }
        //add by ysten wenglei at 20200818: 温度过高，关闭南传硬件加速
        if (SystemProperties.get("ro.ysten.province", "master").equals("CM201_guangdong_zhuoying")){
            if(mAppName != null && ( mAppName.contains("cn.gd.snm.snmcm.LauncherActivity"))){
		        mHardwareAccelerated = false;
		        android.util.Log.e("Window","==leo remove HardwareAccelerated for "+mAppName);
            }
        }
        //end by ysten wenglei at 20200818: 温度过高，关闭南传硬件加速
        if (wm == null) {
