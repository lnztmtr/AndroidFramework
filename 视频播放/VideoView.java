...
public class VideoView extends SurfaceView
    ...
    public void setVideoURI(Uri uri) {
        ...
        //begin: add by ysten wenglei at 20200415: 新闻小窗口显示异常
		if (SystemProperties.get("ro.ysten.province").equals("CM201_guangdong_zhuoying")
			&& VideoView.this.toString().contains("cn.gd.snm.player")) {
			 SurfaceHolder holder = this.getHolder();
			 if (uri == null && (holder!=null)) {
				 if (mVisible && (holder!=null)) {
					 holder.setFormat(PixelFormat.TRANSPARENT);
					 //updateWindow();
				 }
			 }else {
				 if (mVisible && (holder!=null)) {
					 holder.setFormat(PixelFormat.VIDEO_HOLE);
				 }
			 }
        }
        //end: add by ysten wenglei at 20200415: 新闻小窗口显示异常
    }
