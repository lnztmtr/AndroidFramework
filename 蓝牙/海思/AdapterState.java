...
final class AdapterState extends StateMachine {
    ...
    public static void startAutoPairService() {
	Context context = AdapterApp.getContext();
        Intent intent = new Intent();
        String packageName = "com.android.hiBTAutopair"; 
        String className = "com.android.hiBTAutopair.BluetoothService"; 
