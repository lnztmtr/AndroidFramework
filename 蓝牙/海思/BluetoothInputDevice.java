...
public final class BluetoothInputDevice implements BluetoothProfile {
    ...
    public boolean connect(BluetoothDevice device) {
	  if (DBG) Log.i(TAG,"connect(" + device + ")");
			 if (mService != null && isEnabled() && isValidDevice(device)) {
			Log.i(TAG,"hwz  bluetooth start connect");
            try {
					if(SystemProperties.get("android.bluetooth.enableConnect","true").equals("true")){
						SystemProperties.set("android.bluetooth.enableConnect","false");
						Log.i(TAG,"hwz  bluetooth start connect  and  enableConnect = " + SystemProperties.get("android.bluetooth.enableConnect","true"));
    ...
    public boolean disconnect(BluetoothDevice device) {
        ...
        if (mService != null && isEnabled() && isValidDevice(device)) {
            try {
				SystemProperties.set("android.bluetooth.enableConnect","true");
