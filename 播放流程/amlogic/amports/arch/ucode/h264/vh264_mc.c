...
#undef MicroCode
#define MicroCode g12a_vh264_mc
#include "g12a_h264c_linux.h"
...
#undef MicroCode
#define MicroCode g12a_vh264_header_mc
#include "g12a_h264header_linux.h"
...
#undef MicroCode
#define MicroCode g12a_vh264_data_mc
#include "g12a_h264data_linux.h"
...
#undef MicroCode
#define MicroCode g12a_vh264_mmco_mc
#include "g12a_h264mmc_linux.h"
...
#undef MicroCode
#define MicroCode g12a_vh264_list_mc
#include "g12a_h264list_linux.h"
...
#undef MicroCode
#define MicroCode g12a_vh264_slice_mc
#include "g12a_h264slice_linux.h"
...
#define FOR_GXM_CPUS {MESON_CPU_MAJOR_ID_GXM,\
		...
		MESON_CPU_MAJOR_ID_TXHD, 0}

#define FOR_G12A_CPUS {MESON_CPU_MAJOR_ID_G12A,\
		MESON_CPU_MAJOR_ID_G12B,\
		MESON_CPU_MAJOR_ID_GXLX2, 0}

#define FOR_GXTVBB_MULTI_CPUS {MESON_CPU_MAJOR_ID_GXBB,\
		MESON_CPU_MAJOR_ID_GXTVBB,\
		MESON_CPU_MAJOR_ID_GXL, 0}

#define FOR_GXM_MULTI_CPUS {MESON_CPU_MAJOR_ID_GXM,\
		MESON_CPU_MAJOR_ID_TXL,\
		MESON_CPU_MAJOR_ID_TXLX,\
		MESON_CPU_MAJOR_ID_GXLX,\
		MESON_CPU_MAJOR_ID_GXLX2,\
		MESON_CPU_MAJOR_ID_TXHD, 0}


#define FOR_MMU_CPUS {MESON_CPU_MAJOR_ID_TXLX,\
		MESON_CPU_MAJOR_ID_GXLX,\
		MESON_CPU_MAJOR_ID_GXLX2,\
		MESON_CPU_MAJOR_ID_TXHD, 0}
...
#define DEF_FIRMEARE_FOR_G12A(n) \
		DEF_FIRMWARE_FOR_CPUS_TYPE_VER(FOR_G12A_CPUS,\
			FOR_VFORMAT, n, F_VERSION)
...
#define REG_FIRMWARE_ALL()\
	do {\
		...
		DEF_FIRMEARE_FOR_G12A(g12a_vh264_mc);\
