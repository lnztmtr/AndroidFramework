...
*/
/* --------------------------------------------------------------------------*/
int codec_lr_mix_set(codec_para_t *p, int mode)
{
    int ret;
    ret = audio_channel_lrmix_flag_set(p->adec_priv, mode);
    return ret;
}
...
/* --------------------------------------------------------------------------*/
/**
* @brief  audio_set_speed  Set audio speed
*
* @param[in]  p     Pointer of codec parameter structure
* @param[in]  speed
*
...
*/
/* --------------------------------------------------------------------------*/
int audio_set_speed(codec_para_t *p, float speed)
{
    int ret;

    ret = audio_decoder_set_speed(p->adec_priv, speed);
