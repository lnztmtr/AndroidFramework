...
static int parse_avs2_param(char *str, sys_avs2_profile_t *para, int size)
{
    para->exist = 1;

    log_info("avs2 decoder exist.");
    return 0;
}
...
static int parse_param(char *str, char **substr, int size, vdec_profile_t *para)
{
    ...
    } else if (!strcmp(*substr, "avs2:")) {
        parse_avs2_param(str, &para->avs2_para, size);
    }
    return 0;
}
...
static int parse_sysparam_str(vdec_profile_t *m_vdec_profiles, char *str)
{
    ...
    char *p;
    char *substr[] = {"vc1:", "h264:", "real:", "mpeg12:", "mpeg4:", "mjpeg:", "h264_4k2k:", "hmvc:", "hevc:", "avs:", "avs2:"};
