...
/**
 * \file
 * \brief describle the information about 3g card component.
 */
...
\param[out] pstcardnum      3g card number scanned
...
\param[out] pOptnum         operators number scanned
\retval     error code      error code, when success, return HI_SUCCESS
\see \n
*/
...
\param[in]  argnum          3g card optional arg number
\param[in]  argv            3g card optional argv
\retval     error code      error code, when success, return HI_SUCCESS
\see \n
*/
