...
public class Activity extends ContextThemeWrapper
    ...
    private boolean mMbxui = SystemProperties.getBoolean("ro.platform.has.mbxuimode", false);
    ...
    public void startActivity(Intent intent) {
	    if("jiangxi".equalsIgnoreCase(SystemProperties.get("sys.proj.tender.type"))){
	        if(intent != null){
	            if(intent.toString().contains("com.istv.ystfromework.innerbrowser")){
	                Log.d(TAG,"===,startActivity,add flag,new,clear top");
    ...
    public void startActivity(Intent intent, Bundle options) {
        if("bestv.ott.action.localmedia".equals(intent.getAction())
            ...
            intent = new Intent("net.sunniwell.action.LOCALPLAYER");
        }
        if (options != null) {
   ...
   private boolean isIgnorePortraitReq(int requestedOrientation) {
    ...
    public void setRequestedOrientation(int requestedOrientation) {
        ...
        if(mMbxui && requestedOrientation == -1){
            return;
        }
