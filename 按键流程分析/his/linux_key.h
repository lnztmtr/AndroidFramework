...
/*copy from kernle/include/input.h,do not change it */

typedef struct linux_keycode_ {
	 char linux_keycode_name[48];
...
const linux_keycode_ary Linux_KeyCode_Ary[512]=
{
	...
	{"KEY_CAMERA_RIGHT",	0x21a},
        {"KEY_LIVE",   0x271},/*ysten key*/
		{"KEY_MMM_Z",   0x273},/*ysten key*/
	{"KEY_MOVIE",	0x267},/*ysten key*/
	{"KEY_APPS",	0x268},/*ysten key*/
        {"KEY_CHILD_POWER",     0x270},/*ysten key*/
	{"KEY_STAR",     240},/*ysten key star added by yzs */
	{"KEY_MM",     248},/*ysten key star added by zhangy */
	{"KEY_POUND",     55},/*ysten key pound added by yzs */
	{"KEY_FAVOURITE",	0x269},/*ysten key*/
	{"KEY_RECALL",          0x2f0},
	{"KEY_MIN_INTERESTING",	113},
	{"KEY_CHANNELBACK", 0x2bd},
	{"KEY_MAX",			0x2ff},
	{"KEY_CNT",			0x300},
	{"KEY_XIRISEARCH",	0x223}, /*ysten key*/
	{"KEY_XIRIRECORD",	0x224}, /*ysten key*/
	{"KEY_DIAL",	0x225}, /*ysten key*/
	{"KEY_CHILD",	0x226}, /*ysten key*/
	{"KEY_EDUCATION",	0x227}, /*ysten key*/
	{"KEY_XIRIMUSIC",	0x228}, /*ysten key*/
	{"KEY_PE",	0x229}, /*ysten key*/
	{"KEY_GAME",	0x22a}, /*ysten key*/
	{"KEY_APPLIANCE",	0x22b}, /*ysten key*/
	{"KEY_XIRIRED",	0x22c}, /*ysten key*/
	{"KEY_XIRIGREEN",	0x22d}, /*ysten key*/
	{"KEY_XIRIBLUE",	0x22e}, /*ysten key*/
	{"KEY_TV_OPEN",    0x231},/*suoi key  add by sunlei 191009 for Adaptive SUOI'S remote control*/
	{"KEY_SOS_OPEN",    0x232},/*suoi key*/
	{"KEY_SUOI_OPEN",    0x233},/*suoi key*/
	{"KEY_ALBUM_OPEN",    0x234},/*suoi key*/
	{"KEY_CHAT_OPEN",    0x235},/*suoi key*/
	{"KEY_FRIEND_OPEN",    0x236},/*suoi key*/
	{"KEY_HEALTH_OPEN",    0x237},/*suoi key*/
	{"KEY_CHILD_OPEN",    0x238},/*suoi key*/
	{"KEY_MALL_OPEN",    0x239},/*suoi key*/
	{"KEY_ENT_OPEN",    0x23a},/*suoi key*/
	{"KEY_EXPERT_OPEN",    0x23b},/*suoi key*/
	{"KEY_WEATHER_OPEN",    0x23c},/*suoi key*/
	{"KEY_NOTICE_OPEN",    0x23d},/*suoi key*/
	{"KEY_HP_OPEN",    0x23e},/*suoi key  end by sunlei 191009*/
};
