...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    public static final int KEYCODE_F5              = 2054;
    ...
    public static final int KEYCODE_PORTAL = 243;
    ...
    public static final int KEYCODE_TV_SOUND_CHANNEL = 1010;
    ...
    public static final int KEYCODE_VOD_MENU = 2021;	
	 
    public static final int KEYCODE_SOUND_TRACK = 2022;
    
    public static final int KEYCODE_SWITCH = 2023;
	
    public static final int KEYCODE_TVOD_MEN = 2024;

    public static final int KEYCODE_INTERX = 2025;
	 
    public static final int KEYCODE_COMM = 2026;
    
    public static final int KEYCODE_TV_MENU = 2027;
	
    public static final int KEYCODE_APPLICATION = 2028;
	
    public static final int KEYCODE_POS = 2029;
	
    public static final int KEYCODE_CHANNEL_SWITCH= 204;
    public static final int KEYCODE_RED = 136;
    public static final int KEYCODE_GREEN = 137;
    public static final int KEYCODE_YELLOW = 138;
    public static final int KEYCODE_BLUE = 139;
	
    public static final int KEYCODE_HELP = 2030;


    public static final int KEYCODE_XIRISEARCH      = 1189;
    public static final int KEYCODE_XIRIRECORD      = 1190;
    public static final int KEYCODE_DIAL            = 1191;
    public static final int KEYCODE_CHILD           = 1192;
    public static final int KEYCODE_EDUCATION       = 1193;
    public static final int KEYCODE_XIRIMUSIC       = 1194;
    public static final int KEYCODE_PE              = 1195;
    public static final int KEYCODE_GAME            = 1196;
    public static final int KEYCODE_APPLIANCE       = 1197;
    public static final int KEYCODE_XIRIRED         = 1198;
    public static final int KEYCODE_XIRIGREEN       = 1199;
    public static final int KEYCODE_FAVOURITE       = 10006;
    public static final int KEYCODE_RESET       = 10009;
    public static final int KEYCODE_MOVIE           = 10010;
    public static final int KEYCODE_APPS            = 10011;
    
    //begin add by ysten zengzhiliang at 20181120:sync from CM201-2_beijing  add F24 F23 F17 KEY
    public static final int KEYCODE_F24       = 1200;
    public static final int KEYCODE_F23       = 1201;
    public static final int KEYCODE_F17       = 1202;
    //end add by ysten zengzhiliang at 20181120:sync from CM201-2_beijing  add F24 F23 F17 KEY
    //add ysten.zhangjunjian,add M key
    public static final int KEYCODE_MOBILE_M        = 500;
    //end by ysten.zhangjunjian,for M key
    public static final int KEYCODE_XIRIBLUE        = 11100;
    private static final int LAST_KEYCODE           = KEYCODE_XIRIBLUE;
    ...
    private static void populateKeycodeSymbolicNames() {
        ...
        names.append(KEYCODE_PORTAL, "KEYCODE_PORTAL");
	...
	names.append(KEYCODE_VOD_MENU, "KEYCODE_VOD_MENU");
        names.append(KEYCODE_SOUND_TRACK, "KEYCODE_SOUND_TRACK");
        names.append(KEYCODE_SWITCH, "KEYCODE_SWITCH");
	names.append(KEYCODE_TVOD_MEN, "KEYCODE_TVOD_MEN");
        names.append(KEYCODE_INTERX, "KEYCODE_INTERX");
        names.append(KEYCODE_COMM, "KEYCODE_COMM");		
        names.append(KEYCODE_TV_MENU, "KEYCODE_TV_MENU");
        names.append(KEYCODE_APPLICATION, "KEYCODE_APPLICATION");
        names.append(KEYCODE_CHANNEL_SWITCH, "KEYCODE_CHANNEL_SWITCH");	
        names.append(KEYCODE_RED, "KEYCODE_RED");
        names.append(KEYCODE_GREEN, "KEYCODE_GREEN");
        names.append(KEYCODE_YELLOW, "KEYCODE_YELLOW");
        names.append(KEYCODE_BLUE, "KEYCODE_BLUE");
        names.append(KEYCODE_HELP, "KEYCODE_HELP");	

        names.append(KEYCODE_FAVOURITE, "KEYCODE_FAVOURITE");
        names.append(KEYCODE_RESET, "KEYCODE_RESET");
        names.append(KEYCODE_MOVIE, "KEYCODE_MOVIE");
        names.append(KEYCODE_APPS, "KEYCODE_APPS");
        //add by ysten.zhangjunjian,for M key
        names.append(KEYCODE_MOBILE_M, "KEYCODE_MOBILE_M");
       //end by ysten.zhangjunjian,for M key
