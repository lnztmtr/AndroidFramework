...
public class InputManagerService extends IInputManager.Stub
    ...
    private static native void nativeMoveMouse(float x,float y,int deviceid);
    private static native void nativeSetCustomBitmap(int ptr);
    private static native void nativeDispatchMouse(int ptr);
    ...
    **/
    public void registerInputChannel(InputChannel inputChannel) {
        ...
        nativeRegisterInputChannel(mPtr, inputChannel, null, true);
    }
    /**
    ...
    // Native Callback by zhaolianghua
    private PointerIcon getCustomIcon() {
	return cusPointerIcon;
    }
    ...
    //add by sunjh at 20190712 for cloudgaming
    public void setCustomPointerPos(float x,float y){
        nativeMoveMouse(x,y,mPtr);
    }

    PointerIcon cusPointerIcon;
    public void setCustomPointerIcon(Bitmap bitmap ,float hot_x,float hot_y){
        cusPointerIcon = PointerIcon.createCustomIcon(bitmap,hot_x,hot_y);
        // int flag = (int)(Math.random()*3);
        // if(flag == 2){
            // flag = 1;
        // }
        // nativeSetCustomBitmap(flag);// 1
        nativeSetCustomBitmap(1);
        nativeDispatchMouse(mPtr);
    }

    public void recoveryPointerIcon(){
        nativeSetCustomBitmap(0);
        nativeDispatchMouse(mPtr);
    }
    //end by sunjh at 20190712 for cloudgaming
}
