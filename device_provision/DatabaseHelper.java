...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void loadSystemSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            loadStringSetting(stmt, Settings.System.SLEEP_TIME,
                    R.string.def_ysten_sleep_time);
            ...
            if (SystemProperties.get("ro.ysten.province","master").equals("CM201_guangdong")
			    || SystemProperties.get("ro.ysten.province","master").equals("CM201_guangdong_zhuoying")){
              loadIntegerSetting(stmt, Settings.System.TIME_12_24,R.integer.def_time_format);
            }
            //beign:add by ysten zengzhiliang at 20181130:default 24H
            if(SystemProperties.get("ro.ysten.province","master").equals("CM201_beijing"))
            {
				Log.d(TAG,"XXXXXXXXXXXXXXXXXXXXXXX3");
                loadIntegerSetting(stmt, Settings.System.TIME_12_24,R.integer.def_beijing_time_format);
            }
            //end:add by ysten zengzhiliang at 20181130:default 24H
            //end by zhangjunjian
			...
			if(productName.equals("A20_shandong")||productName.equals("CM201_shandong")){
				loadIntegerSetting(stmt,Settings.System.SYSTEM_SLEEP_TIME_DELAY,R.integer.sd_def_system_sleep_time_delay);
				Log.d("ysten_sgc_shandong"," add  sd_def_system_sleep_time_delay ");
			}
			//add by guangchao.su 2018.10.12 for A20_shandong settings devicesleep begin
			//add by zhanghk at 20181109 begin:add jiangsu def_system_sleep_time_delay
			else if(productName.equals("CM201_jiangsu")){
			    loadIntegerSetting(stmt,Settings.System.SYSTEM_SLEEP_TIME_DELAY,R.integer.js_def_system_sleep_time_delay);
			}else if("cm201_jiangxi".equals(productName)){//add by zhaolianghua for jiangxi @20190221
				loadIntegerSetting(stmt,Settings.System.SYSTEM_SLEEP_TIME_DELAY,R.integer.jx_def_system_sleep_time_delay);
			}
			//add by zhanghk at 20181109 end:add jiangsu def_system_sleep_time_delay
            //begin:add by ysten zengzhiliang at 20190125:yunnan_def_system_sleep_time_delay
            else if(productName.equalsIgnoreCase("CM201_yunnan")){
			    loadIntegerSetting(stmt,Settings.System.SYSTEM_SLEEP_TIME_DELAY,R.integer.yunnan_def_system_sleep_time_delay);
			}
            //end:add by ysten zengzhiliang at 20190125:yunnan_def_system_sleep_time_delay

	    /*add by zhaolianghua for guizhou 3am shutdown*/
	    if("cm201_guizhou".equals(SystemProperties.get("ro.ysten.province"))){
    ...
    private void loadSecureSettings(SQLiteDatabase db) {
	    ...
	    loadStringSetting(stmt,Settings.Secure.TTS_DEFAULT_SYNTH,R.string.def_tts_default_synth);
            ...
            loadBooleanSetting(stmt, Settings.Secure.ACCESSIBILITY_SPEAK_PASSWORD,
                    R.bool.def_accessibility_speak_password);
            //add by zongzy at 20180911: begin add jidi data
            loadStringSetting(stmt, Settings.Secure.PWDPROTECTED,R.string.def_pwdprotected);
            //add by zongzy at 20180911: begin add jidi data
	       //add by zhanghk at 20180907: begin add hunan data
             if(SystemProperties.get("ro.ysten.province","master").equals("CM201_hunan")){
                 loadStringSetting(stmt, Settings.Secure.HOME_PAGE,R.string.hn_def_home_page);
             }//add by wuguoqing at 20190303: begin add gansu data
			 else if(SystemProperties.get("ro.ysten.province","master").equals("CM201_IPTV_gansu")){
                 loadStringSetting(stmt, Settings.Secure.HOME_PAGE,R.string.gs_home_page);
             }//add by wuguoqing at 20190303: end add gansu data
			 else{
                 loadStringSetting(stmt, Settings.Secure.HOME_PAGE,R.string.def_home_page);
             }
             //add by zhanghk at 20180907: end add hunan data
	     ...
	     loadStringSetting(stmt, Settings.Secure.UPGRADE_PATH,R.string.def_upgrade_path);
            ...
            loadStringSetting(stmt, Settings.Secure.DEFAULT_SCREEN_RATIO,R.string.def_screen_ratio);
            loadStringSetting(stmt, Settings.Secure.DEFAULT_PLAYER_QUALITY,R.string.def_player_quality);
		...
		&& "1".equals(SystemProperties.get("ro.jidi.nowifi","0"))){
			loadStringSetting(stmt, Settings.Secure.CMCC_WIFI_DISABLED,R.string.def_cmcc_wifi_disabled_nowifi);
              }else{
	          loadStringSetting(stmt, Settings.Secure.CMCC_WIFI_DISABLED,R.string.def_cmcc_wifi_disabled);
              }
	        //add by zhanghk at 20180907: begin add hunan data
              if(SystemProperties.get("ro.ysten.province","master").equals("CM201_hunan")){
                 loadStringSetting(stmt, Settings.Secure.HOME_PAGE2,R.string.hn_def_home_page2); 
              }//add by wuguoqing at 20190303: begin add gansu data
              else if(SystemProperties.get("ro.ysten.province","master").equals("CM201_IPTV_gansu")){
                 loadStringSetting(stmt, Settings.Secure.HOME_PAGE2,R.string.gs_home_page2);
                 loadStringSetting(stmt, Settings.Secure.NTP_SERVER,R.string.def_gs_ntp_server);
                 loadStringSetting(stmt, Settings.Secure.NTP_SERVER2,R.string.def_gs_ntp_server2);
              }//add by wuguoqing at 20190303: end add gansu data
              //add by zhangjunjian at 20200312add hunan gate data
              else if(SystemProperties.get("ro.ysten.province","master").equals("CM202_hunan_gate")){
                 loadStringSetting(stmt, Settings.Secure.HOME_PAGE2,R.string.def_home_page2);
                 loadStringSetting(stmt, Settings.Secure.NTP_SERVER,R.string.def_gs_ntp_server);
                 loadStringSetting(stmt, Settings.Secure.NTP_SERVER2,R.string.def_gs_ntp_server2);
              }//end by zhangjunjian at 20200312add hunan gate data
              //begin:add by zhanghk at 20190521:add zhejiang ntp
              else if(SystemProperties.get("ro.ysten.province","master").equals("CM201_zhejiang")){
                 loadStringSetting(stmt, Settings.Secure.NTP_SERVER,R.string.def_gs_ntp_server);
                 loadStringSetting(stmt, Settings.Secure.NTP_SERVER2,R.string.def_gs_ntp_server);
              }
              //begin:add by xuyunfeng at 20191025:add ningxia ntp
              else if(SystemProperties.get("ro.ysten.province","master").equals("CM201_ningxia")){
                 loadStringSetting(stmt, Settings.Secure.NTP_SERVER,R.string.def_nx_ntp_server);
                 loadStringSetting(stmt, Settings.Secure.NTP_SERVER2,R.string.def_nx_ntp_server2);
              }
              //end:add by xuyunfeng at 20191025:add ningxia ntp
              //end:add by zhanghk at 20190521:add zhejiang ntp
              else{
                  loadStringSetting(stmt, Settings.Secure.HOME_PAGE2,R.string.def_home_page2);
              }
              //add by zhanghk at 20180907: end add hunan data
              //add by zhanghk at 20181015: begin add hunan data
              if(SystemProperties.get("ro.ysten.province","master").equals("CM201_hunan")){
                     loadStringSetting(stmt, Settings.Secure.DHCP_USER,R.string.hn_dhcp_user);
                     loadStringSetting(stmt, Settings.Secure.DHCP_PSWD,R.string.hn_dhcp_password);
                     loadStringSetting(stmt, "eth_dhcp_option",R.integer.hn_dhcp_option);
              }//add by wuguoqing at 20190303: begin add gansu data
             if(SystemProperties.get("ro.ysten.province","master").equals("CM201_IPTV_gansu")){
                  loadStringSetting(stmt, Settings.Secure.DHCP_USER,R.string.gs_dhcp_user);
                  loadStringSetting(stmt, Settings.Secure.DHCP_PSWD,R.string.gs_dhcp_password);
                  loadStringSetting(stmt, "eth_dhcp_option",R.integer.gs_dhcp_option);
                  loadIntegerSetting(stmt, Settings.Secure.DEFAULT_ETH_MOD,R.integer.gs_default_eth_mod);
              }//add by wuguoqing at 20190303: end add gansu data
	      //loadStringSetting(stmt, "gs_iptv_dhcp_option",R.integer.gs_iptv_dhcp_option);
              //add by zhanghk at 20181015: end add hunan data
		loadStringSetting(stmt, Settings.Secure.DLNA_ENABLE,R.string.def_dlna_enable);
		loadStringSetting(stmt, Settings.Secure.SCREEN_SAVER_TIME,R.string.def_screen_saver_time);
		loadStringSetting(stmt, Settings.Secure.SLEEP_TIME,R.string.def_sleep_time);
            //add by zhanghk at 20180907: begin add hunan data
            if(SystemProperties.get("ro.ysten.province","master").equals("CM201_hunan")){
	            loadStringSetting(stmt, Settings.Secure.CMCC_UPGRADE_SOAP_SERVER,R.string.hn_cmcc_upgrade_soap_server);
	            loadStringSetting(stmt, Settings.Secure.CMCC_UPGRADE_STUN_SERVER,R.string.hn_cmcc_upgrade_stun_server);
	            loadStringSetting(stmt, Settings.Secure.UPGRADE_BASEURL,R.string.hn_upgrade_baseurl);
            }
            //add by zhanghk at 20180907: end add hunan data
            loadStringSetting(stmt, Settings.Secure.ACCESSIBILITY_SCREEN_READER_URL,
                    R.string.def_accessibility_screen_reader_url);
            ...
            //add by zhanghk at 20181108 begin:add jiangsu inputmethod
            if("CM201_jiangsu".equals(SystemProperties.get("ro.ysten.province"))) {
                config_defaultIME="com.android.inputmethod.pinyin/.PinyinIME";
            }
            //add by zhanghk at 20181108 end:add jiangsu inputmethod
            //add by zhanghk at 20190520 begin:add zhejiang inputmethod
            if("CM201_zhejiang".equals(SystemProperties.get("ro.ysten.province"))) {
                config_defaultIME="com.android.inputmethod.pinyin/.PinyinIME";
            }
            //add by zhanghk at 20190520 end:add zhejiang inputmethod
            //add by zhangjunjian at 20191112 begin:add zhejiang inputmethod
            if("CM201_guangdong".equals(SystemProperties.get("ro.ysten.province"))
			    || "CM201_guangdong_zhuoying".equals(SystemProperties.get("ro.ysten.province"))) {
                config_defaultIME="net.sunniwell.inputmethod.swpinyin2/.SWIME";
            }
              //add by zhangjunjian at 20191112 end:add zhejiang inputmethod
            // begin by ysten lijg 20190429 for ahaschool
            if(SystemProperties.get("ro.ysten.province","master").contains("CM201_ahaschool")||
                    SystemProperties.get("ro.ysten.province","master").contains("CM201_homeschool")) {
                config_defaultIME="com.android.inputmethod.pinyin/.PinyinIME";
            }
            //end by ysten lijg 20190429 for ahaschool
	    ...
	    loadBooleanSetting(stmt, Settings.Secure.ACCESSIBILITY_QUICK_BOOT,
                    R.bool.def_accessibility_quick_boot);

           loadSetting(stmt, Settings.Secure.ETH_ON, 
                SystemProperties.getBoolean("ro.ethernet.default_on",false) ? 2 : 1);

           loadIntegerSetting(stmt, Settings.Secure.SQM_START_MODE,R.integer.def_sqm_state_mode);
           if(SystemProperties.get("ro.ysten.province","master").equals("CM201_IPTV_gansu")){
             loadIntegerSetting(stmt, Settings.Secure.SQM_START_MODE,R.integer.def_gs_sqm_state_mode);
           }
           loadIntegerSetting(stmt, Settings.Secure.HDR_MODE,R.integer.def_hdr_mode);
		...
		SystemProperties.get("ro.ysten.province","master").contains("jidi")){
			    loadIntegerSetting(stmt, Settings.Secure.ETHV6_ON,R.integer.def_ethv6_on);
                loadStringSetting(stmt, "apk_check_url",R.string.def_apk_check_url);
			}
           if(SystemProperties.get("ro.ysten.province","master").contains("CM201_IPTV_gansu")){
               loadIntegerSetting(stmt, Settings.Secure.ETHV6_ON,R.integer.def_ethv6_on);
               loadStringSetting(stmt, "apk_check_url",R.string.def_apk_check_url);
             }
           //begin:add by ysten xuyunfeng at 20200111:defult open ipv4 and ipv6
           if(SystemProperties.get("ro.ysten.province","master").contains("CM201_ningxia")){
               loadIntegerSetting(stmt, Settings.Secure.ETHV6_ON,R.integer.def_ningxia_ethv6_on);
           }
           //end:add by ysten xuyunfeng at 20200111:defult open ipv4 and ipv6
			loadIntegerSetting(stmt, Settings.Secure.DEFAULT_ETH_MODE,R.integer.def_default_eth_mode);
        } finally {
            if (stmt != null) stmt.close();
        }
    }
    ...
    private void loadGlobalSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            //begin:add by ysten zengzhiliang at 20181204:defult open wifi            
            if(SystemProperties.get("ro.ysten.province","master").equals("CM201_beijing"))
            {
                loadBooleanSetting(stmt, Settings.Global.WIFI_ON,
                    R.bool.def_beijing_wifi_on);
            }
            else
            {
                loadBooleanSetting(stmt, Settings.Global.WIFI_ON,
            ...
            //end:add by ysten zengzhiliang at 20181204:defult open wifi            
            ...
            loadIntegerSetting(stmt, Settings.Global.LOW_BATTERY_SOUND_TIMEOUT,
                    R.integer.def_low_battery_sound_timeout);
            //begin:add by ysten zengzhiliang at 20181130:default allow install makket apps
            if(SystemProperties.get("ro.ysten.province","master").equals("CM201_beijing"))
            {
				Log.d(TAG,"XXXXXXXXXXXXXXXXXXXXXXX1");
				Log.d(TAG,"OOOOOOOOOOOOOOOOOOOOOOOOo1");
                //loadIntegerSetting(stmt, Settings.Global.INSTALL_NON_MARKET_APPS,R.integer.def_install_non_market_apps);
                loadIntegerSetting(stmt, Settings.Global.INSTALL_NON_MARKET_APPS,R.integer.def_beijing_install_non_market_apps);
            }
            else
            {
                loadIntegerSetting(stmt, Settings.Global.INSTALL_NON_MARKET_APPS,R.integer.def_install_non_market_apps);
            }
            //end:add by ysten zengzhiliang at 20181130:default allow install makket apps
            // --- New global settings start here
            loadBooleanSetting(stmt, Settings.Global.HARD_KEYBOARD_DEFAULT_ENABLE, R.bool.def_hard_input_enable);
           //beging:add by ysten xumiao at 20181207:修改屏幕自适应
           //begin:add by zhanghk at 20190221:云南分辨率自适应
           if( "CM202_hunan_gate".equals(SystemProperties.get("ro.ysten.province"))||
                 "CM201_hubei".equals(SystemProperties.get("ro.ysten.province"))||
		   ("CM201_yunnan").equals(SystemProperties.get("ro.ysten.province")) ||
		   "CM201_IPTV_gansu".equals(SystemProperties.get("ro.ysten.province","master"))){
                loadSetting(stmt, Settings.Global.DISPLAY_OUTPUTMODE_AUTO, 1);
           }
           //end:add by zhanghk at 20190221:云南分辨率自适应
           //end:add by ysten xumiao at 20181207:修改屏幕自适应
        } finally {
            if (stmt != null) stmt.close();
        }
    }
