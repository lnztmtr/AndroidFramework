...
*/
    ...
    private boolean parseApplication(Package owner, Resources res,
        ...
        ai.descriptionRes = sa.getResourceId(
         ...
         /*if(("com.antutu.ABenchMark").equals(pkgName) || ("com.antutu.benchmark.full").equals(pkgName)){
        ...
        if ((flags&PARSE_IS_SYSTEM) != 0) {
            if (sa.getBoolean(
                    ...
                    false)) {
                ai.flags |= ApplicationInfo.FLAG_PERSISTENT;
            }else if (("com.android.inputmethod.pinyin".equals(pkgName))||("net.sunniwell.inputmethod.swpinyin2").equals(pkgName)){ // amlogic add this for input method persist running. or ui will not response
                ai.flags |= ApplicationInfo.FLAG_PERSISTENT;   
            }
        }

        //begin: add by ysten.tianchining at 20190827: set nx.mobile.iptv or net.sunniwell.inputmethod.swpinyin2 persistent
        if(pkgName.equals("nx.mobile.iptv") || "net.sunniwell.inputmethod.swpinyin2".equals(pkgName)){
            ai.flags |= ApplicationInfo.FLAG_PERSISTENT;
        }
        //end: add by ysten.tianchining at 20190827: set nx.mobile.iptv or net.sunniwell.inputmethod.swpinyin2 persistent
        if (sa.getBoolean(
    ...
    private Activity parseActivity(Package owner, Resources res,
        ...
        if(null != owner.packageName && (owner.packageName.equals("com.chinamobile.hdcjs") || owner.packageName.equals("com.jscmcc.ottlogin") || owner.packageName.equals("com.chinamobile.launcherjs")))
		pacname = owner.packageName;
        int outerDepth = parser.getDepth();
        int type;
        while ((type=parser.next()) != XmlPullParser.END_DOCUMENT
    ...
    private boolean parseIntent(Resources res, XmlPullParser parser, AttributeSet attrs,
        ...
        if(null != pacname && (pacname.equals("com.chinamobile.hdcjs") || pacname.equals("com.chinamobile.launcherjs") || pacname.equals("com.jscmcc.ottlogin")))
		outInfo.setPriority(1000);
        TypedValue v = sa.peekValue(
