...
final class ActivityStack {
                ...
                case PAUSE_TIMEOUT_MSG: {
                    ...
                    synchronized (mService) {
                        if (r.app != null) {
                            ...
                            //begin:add by zhuhengxuan for timeout load launcher probability and loop bootanimation
                            String r_msg = r.app.toString();
                            if((r_msg.contains("tv.icntv.ott") && SystemProperties.get("ro.ysten.province","master").contains("cm201_beijing"))||(r_msg.contains("chinamobile") && SystemProperties.get("ro.ysten.province","master").contains("jidi"))||(r_msg.contains("tv.icntv.ott") && SystemProperties.get("ro.ysten.province","master").contains("jidi"))
								    ||(r_msg.contains("com.ysten.testtool") && SystemProperties.get("ro.ysten.province","master").contains("jidi"))
								||(r_msg.contains("com.bestv.ott") && SystemProperties.get("ro.ysten.province","master").contains("jidi"))
								||(r_msg.contains("net.sunniwell.service.swupgrade.chinamobile") && SystemProperties.get("ro.ysten.province","master").contains("jidi"))){
                                SystemProperties.set("service.bootanim.exit", "1");
                            }
                            //end:add by zhuhengxuan for timeout load launcher probability and loop bootanimation
                        }
    ...
    public final Bitmap screenshotActivities(ActivityRecord who) {
        ...
        if (mService.mConstantActivityScreenShot != null) {
            return mService.mConstantActivityScreenShot;
        }
    ...
    final boolean finishActivityLocked(ActivityRecord r, int resultCode, Intent resultData,
        ...
        // Reset browser cursor mode here!
        if ("com.android.browser".equals(r.packageName)) {
            Slog.w(TAG, "Sorry, the browser is finished unexpectedly!...");
