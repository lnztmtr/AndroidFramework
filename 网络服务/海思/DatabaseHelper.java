...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    // settings.
    //add by ysten zhanghk at 20180815:update ntp in secure
    private static final int DATABASE_VERSION = 99;

		//add by penghui 基地数据库版本
	private static final int DATABASE_JIDI_VERSION = 98;
    ...
    private static final String DEFAULT_DEVICE_NAME = "Living Room 1";
    ...
    public DatabaseHelper(Context context, int userHandle) {
       ...
       super(context, dbNameForUser(userHandle), null, (SystemProperties.get("ro.ysten.province","master").contains("jidi") ? DATABASE_JIDI_VERSION : DATABASE_VERSION));
        mContext = context;
...
//begin: add by zongzy at 20190116: add for jidi
    private String readSerialnoFromHis(){
        try {
                Process p = Runtime.getRuntime().exec("/system/bin/hissecurezone -r");
                BufferedReader in = new BufferedReader(new InputStreamReader(p.getInputStream()));
                String line = null;
                 while ((line = in.readLine()) != null){
                         if (line.contains("IMEI")&&line.length()>20) {
...
//end: add by zongzy: add for jidi
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int currentVersion) {
        ...
        if (upgradeVersion == 27) {
            String[] settingsToMove = {
                    ...
                    Settings.Secure.WIFI_OPTION60_ON,
                    Settings.Secure.WIFI_OPTION60_LOGIN,
                    Settings.Secure.WIFI_OPTION60_PASSWORD,
                    Settings.Secure.WIFI_OPTION125_ON,
                    Settings.Secure.WIFI_OPTION125_INFO,
                    Settings.Secure.WIFI_IPV6_OPTION60_ON,
                    Settings.Secure.WIFI_IPV6_OPTION60_LOGIN,
                    Settings.Secure.WIFI_IPV6_OPTION60_PASSWORD,
                    Settings.Secure.WIFI_IPV6_OPTION125_ON,
                    Settings.Secure.WIFI_IPV6_OPTION125_INFO,
                    Settings.Secure.WIFI_IPV6_IP,
                    Settings.Secure.WIFI_IPV6_PREFIXLENGTH,
                    Settings.Secure.WIFI_IPV6_ROUTE,
                    Settings.Secure.WIFI_IPV6_DNS_1,
                    Settings.Secure.WIFI_IPV6_DNS_2,
                    Settings.Secure.ETHERNET_ON,
                    Settings.Secure.ETHERNET_MODE,
                    Settings.Secure.ETHERNET_IP,
                    Settings.Secure.ETHERNET_PREFIXLENGTH,
                    Settings.Secure.ETHERNET_DNS_1,
                    Settings.Secure.ETHERNET_DNS_2,
                    Settings.Secure.ETHERNET_ROUTE,
                    Settings.Secure.ETHERNET_IFNAME,
                    Settings.Secure.ETHERNET_AUTORECONNECT,
                    Settings.Secure.OPTION60_ON,
                    Settings.Secure.OPTION60_LOGIN,
                    Settings.Secure.OPTION60_PASSWORD,
                    Settings.Secure.OPTION125_ON,
                    Settings.Secure.OPTION125_INFO,
                    Settings.Secure.WIFI_DISGUISE,
                    Settings.Secure.PPPOE_USER_NAME,
                    Settings.Secure.PPPOE_USER_PASS,
                    Settings.Secure.PPPOE_MODE,
                    Settings.Secure.WIFI_ETHERNET_COEXIST,
                    Settings.Secure.IPV6_ON,
                    Settings.Secure.ETHERNET_IPV6_MODE,
                    Settings.Secure.ETHERNET_IPV6_IP,
                    Settings.Secure.ETHERNET_IPV6_PREFIXLENGTH,
                    Settings.Secure.ETHERNET_IPV6_DNS_1,
                    Settings.Secure.ETHERNET_IPV6_DNS_2,
                    Settings.Secure.ETHERNET_IPV6_ROUTE,
                    Settings.Secure.ETHERNET_PPPOE_IPV6_STATELESS,
                    Settings.Secure.G3_USER_NAME,
                    Settings.Secure.G3_USER_PASS,
                    Settings.Secure.G3_APN_NAME,
                    Settings.Secure.G3_DIAL_NUMBER,
                    Settings.Secure.G3_PIN_CODE,
                    Settings.Secure.G3_ON,
                    Settings.Secure.G3_AUTORECONNECT,
                    Settings.Secure.G3_CONNECT_MODE,

                    Settings.Secure.HI_ETHERNET_ON,
                    Settings.Secure.HI_ETHERNET_MODE,
                    Settings.Secure.HI_ETHERNET_IP,
                    Settings.Secure.HI_ETHERNET_PREFIXLENGTH,
                    Settings.Secure.HI_ETHERNET_DNS_1,
                    Settings.Secure.HI_ETHERNET_DNS_2,
                    Settings.Secure.HI_ETHERNET_ROUTE,
                    Settings.Secure.HI_ETHERNET_IFNAME,
                    Settings.Secure.HI_ETHERNET_AUTORECONNECT,
                    Settings.Secure.HI_OPTION60_ON,
                    Settings.Secure.HI_OPTION60_LOGIN,
                    Settings.Secure.HI_OPTION60_PASSWORD,
                    Settings.Secure.HI_OPTION125_ON,
                    Settings.Secure.HI_OPTION125_INFO,

                    Settings.Secure.HI_IPV6_ON,
                    Settings.Secure.HI_ETHERNET_IPV6_MODE,
                    Settings.Secure.HI_ETHERNET_IPV6_IP,
                    Settings.Secure.HI_ETHERNET_IPV6_PREFIXLENGTH,
                    Settings.Secure.HI_ETHERNET_IPV6_DNS_1,
                    Settings.Secure.HI_ETHERNET_IPV6_DNS_2,
                    Settings.Secure.HI_ETHERNET_IPV6_ROUTE,
                };
       ...
       if (upgradeVersion == 51) {
        ...
        //begin:add by ysten zhanghk at 20180815:update ntp in secure
        //add by ysten zhanghk at 20180912:only upgradeVersion is 98 when province is zhejiang

            if (upgradeVersion == 98) {
			if (SystemProperties.get("ro.ysten.province","master").equals("cm201_zhejiang")){
                if (mUserHandle == UserHandle.USER_OWNER) {
                   db.beginTransaction();
                   try {
                      db.execSQL("UPDATE secure SET value='cn.pool.ntp.org' " +
                          "WHERE name='" + Settings.Secure.NTP_SERVER + "'");
                      db.execSQL("UPDATE secure SET value='cn.pool.ntp.org' " +
                          "WHERE name='" + Settings.Secure.NTP_SERVER2 + "'");
                      db.setTransactionSuccessful();
                   } finally {
                      db.endTransaction();
                   }
                }
            }//begin by lizheng 20181225 solve database will be wiped when upgrade
			upgradeVersion = 99;
             //end  by lizheng 20181225 solve database will be wiped when upgrade
			if (SystemProperties.get("ro.ysten.province","master").contains("jidi")){
                upgradeVersion = 98;
            }
			}
        //end:add by ysten zhanghk at 20180815:update ntp in secure
    ...
    private void loadSecureSettingsForSHYD(SQLiteStatement stmt) {
        loadStringSetting(stmt, Settings.Secure.UPGRADE_URL, R.string.def_upgrade_url);
        loadStringSetting(stmt, Settings.Secure.UPGRADE_PATH, R.string.def_upgrade_path);
        loadStringSetting(stmt, Settings.Secure.NTVUSERACCOUNT, R.string.def_ntvuseraccount);
        loadStringSetting(stmt, Settings.Secure.NTVUSERSUFFIX, R.string.def_ntvusersuffix);
        loadStringSetting(stmt, Settings.Secure.NTVUSERPASSWORD, R.string.def_ntvuserpassword);
        loadStringSetting(stmt, Settings.Secure.DHCP_OPTION, R.string.def_dhcp_option);
        loadStringSetting(stmt, Settings.Secure.DHCP_IPVER, R.string.def_dhcp_ipver);
        loadStringSetting(stmt, Settings.Secure.PPPOE_USERNAME, R.string.def_pppoe_username);
        loadStringSetting(stmt, Settings.Secure.PPPOE_PSWD, R.string.def_pppoe_pswd);
        loadStringSetting(stmt, Settings.Secure.NTP_SERVER, R.string.def_ntp_server);
        loadStringSetting(stmt, Settings.Secure.NTP_SERVER2, R.string.def_ntp_server2);
        loadStringSetting(stmt, Settings.Secure.SQM_START_MODE, R.string.def_sqm_start_mode);
        /*begin:add by zhanghk at 20190306:add hunan data,change type*/
        if(SystemProperties.get("ro.ysten.province","master").equals("cm201_hunan")){
            loadStringSetting(stmt, Settings.Secure.HOME_PAGE, R.string.def_hunan_home_page);
            loadStringSetting(stmt, Settings.Secure.HOME_PAGE, R.string.def_hunan_home_page2);
            loadStringSetting(stmt, Settings.Secure.DHCP_USER, R.string.def_hunan_dhcp_user);
            loadStringSetting(stmt, Settings.Secure.DHCP_PSWD, R.string.def_hunan_dhcp_pswd);
            loadIntegerSetting(stmt, Settings.Secure.DEFAULT_PLAYER_QUALITY,R.integer.hn_default_player_quality);
            loadIntegerSetting(stmt, Settings.Secure.SPDIF_PASSTHROUGH,R.integer.hn_spdif_passthrough);
            loadIntegerSetting(stmt, Settings.Secure.HDMI_PASSTHROUGH,R.integer.hn_hdmi_passthrough);
            loadIntegerSetting(stmt, Settings.Secure.CEC_TV_TO_STB,R.integer.hn_cec_tv_to_stb);
            loadIntegerSetting(stmt, Settings.Secure.CEC_STB_TO_TV,R.integer.hn_cec_stb_to_tv);
            loadIntegerSetting(stmt, Settings.Secure.CMCC_WIFI_DISABLED,R.integer.hn_cmcc_wifi_disabled);
            loadIntegerSetting(stmt, Settings.Secure.DEFAULT_SCREEN_RATIO,R.integer.hn_default_screen_ratio);
        }else{
            loadStringSetting(stmt, Settings.Secure.HOME_PAGE, R.string.def_home_page);
            loadStringSetting(stmt, Settings.Secure.HOME_PAGE2, R.string.def_home_page2);
            loadStringSetting(stmt, Settings.Secure.DHCP_USER, R.string.def_dhcp_user);
            loadStringSetting(stmt, Settings.Secure.DHCP_PSWD, R.string.def_dhcp_pswd);
            loadStringSetting(stmt, Settings.Secure.DEFAULT_PLAYER_QUALITY, R.string.def_default_player_quality);
            loadStringSetting(stmt, Settings.Secure.SPDIF_PASSTHROUGH, R.string.def_spdif_passthrough);
            loadStringSetting(stmt, Settings.Secure.HDMI_PASSTHROUGH, R.string.def_hdmi_passthrough);
            loadStringSetting(stmt, Settings.Secure.DEFAULT_SCREEN_RATIO, R.string.def_default_screen_ratio);
            loadStringSetting(stmt, Settings.Secure.CEC_TV_TO_STB, R.string.def_cec_tv_to_stb);
            loadStringSetting(stmt, Settings.Secure.CEC_STB_TO_TV, R.string.def_cec_stb_to_tv);
			if(SystemProperties.get("ro.ysten.province","master").contains("jidi")){
		         if(SystemProperties.get("persist.sys.jidiwifi","1").equals("0")){
                           if(SystemProperties.get("ro.ysten.province","master").contains("hainan")){
			       loadStringSetting(stmt, Settings.Secure.CMCC_WIFI_DISABLED, R.string.def_hn_cmcc_wifi_disabled);
                           }else{
                               loadStringSetting(stmt, Settings.Secure.CMCC_WIFI_DISABLED, R.string.def_cq_cmcc_wifi_disabled);
                           }
                           }else{
		           loadStringSetting(stmt, Settings.Secure.CMCC_WIFI_DISABLED, R.string.def_cmcc_wifi_disabled);
				 }
	       }else{
                loadStringSetting(stmt, Settings.Secure.CMCC_WIFI_DISABLED, R.string.def_cmcc_wifi_disabled);
	       }
        }
        /*end:add by zhanghk at 20190306:add hunan data,change type*/
        loadStringSetting(stmt, Settings.Secure.INSTALL_NON_MARKET_APPS, R.string.def_install_non_market_apps);
        loadIntegerSetting(stmt, Settings.Secure.SCREEN_SAVER_TIMEOUT,R.integer.screen_saver_time);
        /*begin:add by zhanghk at 20190306:add hunan new data*/
        if(SystemProperties.get("ro.ysten.province","master").equals("cm201_hunan")){
            loadStringSetting(stmt, Settings.Secure.APK_CHECK_URL, R.string.def_apk_check_url);
            loadIntegerSetting(stmt, Settings.Secure.DEFAULT_NETWORK_PRIORITY,R.integer.def_default_network_priority);
            loadIntegerSetting(stmt, Settings.Secure.CMCC_BLUETOOTH_DISABLED, R.integer.def_cmcc_bluetooth_disabled);
            loadIntegerSetting(stmt, Settings.Secure.DLNA_ENABLE,R.integer.def_dlna_enable);
            loadIntegerSetting(stmt, Settings.Secure.DIAGNOSE_PWDPROTECTED,R.integer.def_diagnose_pwdprotected);
            loadIntegerSetting(stmt, Settings.Secure.SLEEP_TIME,R.integer.hn_sleep_time);
            loadSetting(stmt, "iptv_home_page", "http://111.23.234.96:8095");
            loadSetting(stmt, "iptv_home_page2", "http://111.23.234.96:8095");
        }
        /*end:add by zhanghk at 20190306:add hunan new data*/
        //begin: add by zongzy at 20190112: add for jidi
        if(SystemProperties.get("ro.ysten.province","master").contains("jidi")){
	    loadIntegerSetting(stmt, Settings.Secure.DEFAULT_NETWORK_PRIORITY,R.integer.def_default_network_priority);
            loadStringSetting(stmt, Settings.Secure.ETH_DHCP_OPTION, R.string.def_eth_dhcp_option);
            loadStringSetting(stmt, Settings.Secure.PWDPROTECTED,R.string.def_pwdprotected);
			if(SystemProperties.get("persist.sys.jidiwifi","1").equals("0")){
                          if(SystemProperties.get("ro.ysten.province","master").contains("hainan")){
			    loadStringSetting(stmt, Settings.Secure.CMCC_WIFI_DISABLED, R.string.def_hn_cmcc_wifi_disabled);
                          }else{
        ...
        //end: add by zongzy at 20190112: add for jidi
        //begin add by guxin for jiangxi change system_sleep_time_delay to sleep_time
        if(SystemProperties.get("ro.ysten.province","master").contains("jiangxi")){
           loadIntegerSetting(stmt, Settings.Secure.SLEEP_TIME,R.integer.jx_def_system_sleep_time_delay);
        }
    }
    private void loadSystemSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            //guangdong,zhangjunjian,20180830,add format time in system sql
            if (SystemProperties.get("ro.ysten.province","master").equals("cm201_guangdong")
             ||SystemProperties.get("ro.ysten.province","master").equals("cm201_guizhou")){
              loadIntegerSetting(stmt, Settings.System.TIME_12_24,R.integer.def_time_format);
            }
            //end by zhangjunjian
            //begin by ysten.zhangjunjian,20190719.add for guizhou pingbao
            if (SystemProperties.get("ro.ysten.province","master").contains("guizhou")){
               //loadIntegerSetting(stmt, "screen_save_delay",30);
            }
            //end by ysten.zhangjunjian,20190719,add for guizhou pingbao
            ...
            //add by ysten.zhangjunjian,default guizhou system_sleep_time_delay -1
            if(SystemProperties.get("ro.ysten.province","master").equals("cm201_zhejiang")
               ||SystemProperties.get("ro.ysten.province","master").equals("cm201_shaanxi")
		       ||SystemProperties.get("ro.ysten.province","master").equals("cm201_fujian")
               ||SystemProperties.get("ro.ysten.province","master").contains("guizhou")){
			     loadIntegerSetting(stmt, Settings.System.SYSTEM_SLEEP_TIME_DELAY,R.integer.zj_def_system_sleep_time_delay);
			//begin:add by ysten xumiao at 20181008:modify defult sleep time 3 hour
			}else if(SystemProperties.get("ro.ysten.province","master").equals("c60_jiangsu")){
				int defultTime=180;
				loadSetting(stmt, Settings.System.SYSTEM_SLEEP_TIME_DELAY,defultTime);
			//end:add by ysten xumiao at 20181008:modify defult sleep time 3 hour
			}else if(SystemProperties.get("ro.ysten.province","master").equals("cm201_beijing")){
				loadSetting(stmt, Settings.System.SYSTEM_SLEEP_TIME_DELAY,"-1");
			}else{
				loadIntegerSetting(stmt, Settings.System.SYSTEM_SLEEP_TIME_DELAY,
                    R.integer.def_system_sleep_time_delay);
			}
            if(SystemProperties.get("ro.ysten.province","master").equals("cm201_guizhou")){
                loadStringSetting(stmt,"system_power_off_time_delay",R.string.gz_def_system_power_off_time_delay);
            }
        } finally {
            if (stmt != null) stmt.close();
        }
    ...
    private void loadSecureSettings(SQLiteDatabase db) {
        ...
        try {
            stmt = db.compileStatement("INSERT OR IGNORE INTO secure(name,value)"
                    + " VALUES(?,?);");
			loadBooleanSetting(stmt, Settings.Secure.WIFI_OPTION60_ON,
                    R.bool.def_wifi_option60_on);
			loadBooleanSetting(stmt, Settings.Secure.WIFI_OPTION125_ON,
                    R.bool.def_wifi_option125_on);
            loadBooleanSetting(stmt, Settings.Secure.WIFI_IPV6_OPTION60_ON,
                    R.bool.def_wifi_ipv6_option60_on);
            loadBooleanSetting(stmt, Settings.Secure.WIFI_IPV6_OPTION125_ON,
                    R.bool.def_wifi_ipv6_option125_on);
            loadBooleanSetting(stmt, Settings.Secure.HI_ETHERNET_ON,
                R.bool.def_hi_ethernet_on);
            loadStringSetting(stmt, Settings.Secure.HI_ETHERNET_IFNAME,
                R.string.def_hi_ethernet_ifname);
            loadStringSetting(stmt, Settings.Secure.HI_ETHERNET_IP,
                R.string.def_hi_ethernet_ip);
            loadIntegerSetting(stmt, Settings.Secure.HI_ETHERNET_PREFIXLENGTH,
                R.integer.def_hi_ethernet_prefixlength);
            loadStringSetting(stmt, Settings.Secure.HI_ETHERNET_DNS_1,
                R.string.def_hi_ethernet_dns_1);
            loadStringSetting(stmt, Settings.Secure.HI_ETHERNET_DNS_2,
                R.string.def_hi_ethernet_dns_2);
            loadStringSetting(stmt, Settings.Secure.HI_ETHERNET_ROUTE,
                R.string.def_hi_ethernet_route);
            loadBooleanSetting(stmt, Settings.Secure.HI_ETHERNET_AUTORECONNECT,
                R.bool.def_hi_ethernet_autoreconnect);
            loadBooleanSetting(stmt, Settings.Secure.HI_OPTION60_ON,
                R.bool.def_hi_option60_on);
            loadBooleanSetting(stmt, Settings.Secure.HI_OPTION125_ON,
                R.bool.def_hi_option125_on);

            loadStringSetting(stmt, Settings.Secure.LOCATION_PROVIDERS_ALLOWED,
                    R.string.def_location_providers_allowed);
            loadBooleanSetting(stmt, Settings.Secure.ETHERNET_ON,
                    R.bool.def_ethernet_on);
            loadStringSetting(stmt,Settings.Secure.TTS_DEFAULT_SYNTH,R.string.def_tts_default_synth);

            loadIntegerSetting(stmt, Settings.Secure.IPV4_ON,
                    R.integer.def_ipv4_on);
            ...
            loadIntegerSetting(stmt, Settings.Secure.ETHERNET_PREFIXLENGTH,
                    R.integer.def_ethernet_prefixlength);

            loadStringSetting(stmt, Settings.Secure.ETHERNET_DNS_1,
                    R.string.def_ethernet_dns_1);

            loadStringSetting(stmt, Settings.Secure.ETHERNET_DNS_2,
                    R.string.def_ethernet_dns_2);

            loadStringSetting(stmt, Settings.Secure.ETHERNET_ROUTE,
                    R.string.def_ethernet_route);

            loadBooleanSetting(stmt, Settings.Secure.ETHERNET_AUTORECONNECT,
                    R.bool.def_ethernet_autoreconnect);
            loadBooleanSetting(stmt, Settings.Secure.ETHERNET_IPV6_MO_VALID,
                    R.bool.def_ethernet_ipv6_mo_valid);
            //begin:add by ysten zengzhiliang at 20180927 :open ipoe
	        if(SystemProperties.get("ro.ysten.province","master").equals("CM201-2_shanxi_iptv")
                    ...
                    || SystemProperties.get("ro.ysten.province","master").contains("yunnan")
                    || SystemProperties.get("ro.ysten.province","master").contains("guangdong")
                    || SystemProperties.get("ro.ysten.province","master").contains("cm201_anhui_iptv")
                    || SystemProperties.get("ro.ysten.province","master").contains("guizhou")
                    || SystemProperties.get("ro.ysten.province","master").equals("cm201_neimeng")
                    || SystemProperties.get("ro.ysten.province","master").equals("cm201_hainan")
                    || SystemProperties.get("ro.ysten.province","master").equals("cm201_jilin")
					|| SystemProperties.get("ro.ysten.sub.province","master").equals("cm201_hainan_jidi"))// add by ysten tianchining at 20181126
            {
                
                if(SystemProperties.get("ro.ysten.province","master").equals("cm201_neimeng")
                    && SystemProperties.get("persist.sys.nm.product","").equals("CM211")){
                        //add by ysten wenglei at 20201021 :neimeng cm211 default dhcp no option60
                        loadBooleanSetting(stmt, Settings.Secure.OPTION60_ON,R.bool.def_option60_on);
                    }else{
                        /*for open OPTION60_ON*/
                        loadSetting(stmt, Settings.Secure.OPTION60_ON,1);
                }
            ...
            //end:add by ysten zengzhiliang at 20180927 :open ipoe
            /*begin:add by zhanghk at 20190215 :open ipoe */
            if(SystemProperties.get("ro.ysten.province","master").equals("cm201_hainan")) {
                    loadStringSetting(stmt, "eth_dhcp_option",R.string.hn_dhcp_option);
            }
            /*end:add by zhanghk at 20190215 :open ipoe */
            loadBooleanSetting(stmt, Settings.Secure.OPTION125_ON,
                    R.bool.def_option125_on);

            loadStringSetting(stmt, Settings.Secure.PPPOE_MODE,
                    R.string.def_pppoe_mode);

            loadBooleanSetting(stmt, Settings.Secure.WIFI_ETHERNET_COEXIST,
                                R.bool.def_wifi_ethernet_coexist);

            //add by ysten xumiao at 20191118: modify liaoning IPV6_ON on
            if(SystemProperties.get("ro.ysten.province","master").equals("CM201-2_liaoning") ||
               ...
               SystemProperties.get("ro.ysten.province","master").contains("hebei") ||
               SystemProperties.get("ro.ysten.province","master").contains("beijing")){//add by ysten xumiao at 20191118: modify neimeng IPV6_ON on
                loadSetting(stmt, Settings.Secure.IPV6_ON,1);
            }else{
                loadBooleanSetting(stmt, Settings.Secure.IPV6_ON,
                                R.bool.def_ipv6_on);
            }
            //add by ysten xumiao at 20191118: modify liaoning IPV6_ON on
           //add by ysten zhangjunjian at 20191212: modify hainan IPV4_ON IPV6_ON on
           if(SystemProperties.get("ro.ysten.province","master").equals("cm201_hainan")){
              loadIntegerSetting(stmt, Settings.Secure.IPV6_ON, R.integer.def_ipv6_state);
              //loadIntegerSetting(stmt, Settings.Secure.IPV4_ON, R.integer.def_ipv4_state);
             }
            //end by ysten zhangjunjian at 20191212: modify hainan IPV4_ON IPV6_ON on
            //begin : add by ysten xuyunfeng at 20200305: set shanxi IPV6_ON on
            if(SystemProperties.get("ro.ysten.province","master").contains("shanxi")){
                loadIntegerSetting(stmt, Settings.Secure.IPV6_ON, R.integer.def_ipv6_state);
            }
            //end : add by ysten xuyunfeng at 20200305: set shanxi IPV6_ON on
            loadStringSetting(stmt, Settings.Secure.ETHERNET_IPV6_MODE,
                                R.string.def_ethernet_ipv6_mode);

            loadStringSetting(stmt, Settings.Secure.ETHERNET_IPV6_IP,
                    R.string.def_ethernet_ipv6_ip);

            loadIntegerSetting(stmt, Settings.Secure.ETHERNET_IPV6_PREFIXLENGTH,
                    R.integer.def_ethernet_ipv6_prefixlength);

            loadStringSetting(stmt, Settings.Secure.ETHERNET_IPV6_DNS_1,
                    R.string.def_ethernet_ipv6_dns_1);

            loadStringSetting(stmt, Settings.Secure.ETHERNET_IPV6_DNS_2,
                    R.string.def_ethernet_ipv6_dns_2);

            loadStringSetting(stmt, Settings.Secure.ETHERNET_IPV6_ROUTE,
                    R.string.def_ethernet_ipv6_route);

            loadBooleanSetting(stmt, Settings.Secure.HI_IPV6_ON,
                                R.bool.def_ipv6_on);

            loadStringSetting(stmt, Settings.Secure.HI_ETHERNET_IPV6_MODE,
                                R.string.def_ethernet_ipv6_mode);

            loadStringSetting(stmt, Settings.Secure.HI_ETHERNET_IPV6_IP,
                    R.string.def_ethernet_ipv6_ip);

            loadIntegerSetting(stmt, Settings.Secure.HI_ETHERNET_IPV6_PREFIXLENGTH,
                    R.integer.def_ethernet_ipv6_prefixlength);

            loadStringSetting(stmt, Settings.Secure.HI_ETHERNET_IPV6_DNS_1,
                    R.string.def_ethernet_ipv6_dns_1);

            loadStringSetting(stmt, Settings.Secure.HI_ETHERNET_IPV6_DNS_2,
                    R.string.def_ethernet_ipv6_dns_2);

            loadStringSetting(stmt, Settings.Secure.HI_ETHERNET_IPV6_ROUTE,
                    R.string.def_ethernet_ipv6_route);

            loadBooleanSetting(stmt, Settings.Secure.ETHERNET_PPPOE_IPV6_STATELESS,
                    R.bool.def_ethernet_pppoe_ipv6_stateless);

            loadStringSetting(stmt, Settings.Secure.WIFI_IPV6_IP,
                    R.string.def_wifi_ipv6_ip);

            loadIntegerSetting(stmt, Settings.Secure.WIFI_IPV6_PREFIXLENGTH,
                    R.integer.def_wifi_ipv6_prefixlength);

            loadStringSetting(stmt, Settings.Secure.WIFI_IPV6_ROUTE,
                    R.string.def_wifi_ipv6_route);

            loadStringSetting(stmt, Settings.Secure.WIFI_IPV6_DNS_1,
                    R.string.def_wifi_ipv6_dns_1);

            loadStringSetting(stmt, Settings.Secure.WIFI_IPV6_DNS_2,
                    R.string.def_wifi_ipv6_dns_2);

            loadStringSetting( stmt, Settings.Secure.DEFAULT_INPUT_METHOD,
                    R.string.config_default_input_method );
            loadBooleanSetting(stmt, Settings.Secure.G3_ON,
                    R.bool.def_g3_on);
            loadIntegerSetting(stmt, Settings.Secure.G3_CONNECT_MODE,
                    R.integer.def_g3_connect_mode);

            loadBooleanSetting(stmt, Settings.Secure.G3_AUTORECONNECT,
                    R.bool.def_g3_autoreconnect);
            String wifiWatchList = SystemProperties.get("ro.com.android.wifi-watchlist");
            if (!TextUtils.isEmpty(wifiWatchList)) {
            ...
            if(SystemProperties.get("ro.ysten.province","master").equals("c60_jiangsu")){
			    /*for jiangsu cp add by chenfeng*/
			    loadSetting(stmt, Settings.Secure.NTP_SERVER, "183.207.253.53");
			    loadSetting(stmt, Settings.Secure.NTP_SERVER2, "183.207.249.76");
            }
            if(SystemProperties.get("ro.ysten.province","master").equals("cm201_zhejiang")){
			    /*for zhejiang cp add by zhanghk*/
			    loadSetting(stmt, Settings.Secure.NTP_SERVER, "cn.pool.ntp.org");
			    loadSetting(stmt, Settings.Secure.NTP_SERVER2, "cn.pool.ntp.org");
            }
            /*begin:add by zhanghk at 20181221:add shaanxi ntp*/
            if(SystemProperties.get("ro.ysten.province","master").equals("cm201_shaanxi")){
                if(0 == SystemProperties.getInt("persist.sys.platform",0)){
                    loadSetting(stmt, Settings.Secure.NTP_SERVER, "111.52.199.146");
                    loadSetting(stmt, Settings.Secure.NTP_SERVER2, "111.52.199.146");
                }else{
                    loadSetting(stmt, Settings.Secure.NTP_SERVER, "111.52.2.4");
                    loadSetting(stmt, Settings.Secure.NTP_SERVER2, "111.52.2.4");
                }
            }
            /*end:add by zhanghk at 20181221:add shaanxi ntp*/
            /*begin:add by zhanghk at 20190306:add hunan ntp*/
            if(SystemProperties.get("ro.ysten.province","master").equals("cm201_hunan")){
                    loadSetting(stmt, Settings.Secure.NTP_SERVER, "cn.pool.ntp.org");
                    loadSetting(stmt, Settings.Secure.NTP_SERVER2, "221.181.100.40");
            }
            /*end:add by zhanghk at 20190306:add hunan ntp*/
      if(SystemProperties.get("ro.ysten.province","master").equals("FJ")){
			    /*for jiangsu cp add by chenfeng*/
			    loadSetting(stmt, Settings.Secure.NTP_SERVER, "112.50.228.32");
			    loadSetting(stmt, Settings.Secure.NTP_SERVER2, "112.50.228.33");
      }
      //begin by zhangyong at 20181121:add neimeng ntp
      if(SystemProperties.get("ro.ysten.province","master").equals("cm201_neimeng")){
            if(SystemProperties.get("persist.sys.nm.product","").equals("CM211")){
                //add by ysten wenglei at 20201021: neimeng cm211 ntp
                loadSetting(stmt, Settings.Secure.NTP_SERVER, "117.161.133.32");
			    loadSetting(stmt, Settings.Secure.NTP_SERVER2, "117.161.133..33");
            }else{
                /*for neimeng cp add by chenfeng*/
                loadSetting(stmt, Settings.Global.NTP_SERVER, "111.56.116.138");
                Log.d("zhangyong", "write ntp ip 111.56.116.138 to database");
                //   loadSetting(stmt, Settings.Global.NTP_SERVER2, "111.56.116.139");
            }
       }
     //end by make at 20190621:add heilongjiang ntp
      if(SystemProperties.get("ro.ysten.province","master").contains("heilongjiang")){
			    /*for heilongjiang cp add by zengzhiliang*/
			    loadSetting(stmt, Settings.Secure.NTP_SERVER, "111.40.205.93");
			    loadSetting(stmt, Settings.Secure.NTP_SERVER2, "111.40.205.94");
      }
      //begin by zhanghk at 20180809:add henan ntp
      if(SystemProperties.get("ro.ysten.province","master").equals("cm201_henan")){
			    /*for heilongjiang cp add by zengzhiliang*/
			    loadSetting(stmt, Settings.Secure.NTP_SERVER, "111.7.144.201");
			    loadSetting(stmt, Settings.Secure.NTP_SERVER2, "111.7.144.202");
      }
      //end by zhanghk at 20180809:add henan ntp
	  //begin by guangchao.su at 20180811:add jiangxi ntp
      if(SystemProperties.get("ro.ysten.province","master").equals("cm201_jiangxi")){
                           loadSetting(stmt, Settings.Secure.NTP_SERVER, "117.169.36.136");
                Log.w(TAG, "use this ntp 117.169.36.136 , use this province is "+SystemProperties.get("ro.ysten.province","master"));
      }
      //end by guangchao.su at 20180811:add jiangxi ntp
          //begin by zhangjunjian at 20180828:add guangzhou ntp
      if(SystemProperties.get("ro.ysten.province","master").equals("cm201_guangzhou")){
                           loadSetting(stmt, Settings.Secure.NTP_SERVER, "183.235.3.59");
                Log.w(TAG, "use this ntp 117.169.36.136 , use this province is "+SystemProperties.get("ro.ysten.province","master"));
      }
      //end by zhangjunjian at 20180913:add guizhou

      if(SystemProperties.get("ro.ysten.province","master").equals("cm201_guizhou")){
                  loadSetting(stmt, Settings.Secure.NTP_SERVER, SystemProperties.get("persist.sys.ntp.server1","iptvntp.gz.chinamobile.com"));
                  loadSetting(stmt, Settings.Secure.NTP_SERVER2, SystemProperties.get("persist.sys.ntp.server2","iptvntp.gz.chinamobile.com"));
      }
      //end by zhangjunjian at 20180913:add guizhou ntp
      //begin:add by ysten zhuhengxuan at 20191202 for beijing ntp
      if(SystemProperties.get("ro.ysten.province","master").contains("beijing")){
                Log.d(TAG,"zhs get ntp server 111111111111 "+Settings.Secure.NTP_SERVER);
                loadSetting(stmt, Settings.Secure.NTP_SERVER, "cn.pool.ntp.org");
                loadSetting(stmt, Settings.Secure.NTP_SERVER2, "221.179.217.4");
                //loadIntegerSetting(stmt, Settings.Secure.HDMI_PASSTHROUGH,R.integer.def_beijing_hdmi_passthrough);
      }
      //begin:end by ysten zhuhengxuan at 20191202 for beijing ntp

      if(SystemProperties.get("ro.ysten.province","master").contains("yunnan")){
			    /*for yunnan cp add by zengzhiliang*/
          Log.d(TAG,"ZZL get eth mac address:"+getEthMacAddress());
            loadSetting(stmt,Settings.Secure.OPTION60_LOGIN,getEthMacAddress());
            loadSetting(stmt,Settings.Secure.OPTION60_PASSWORD,"yncmcc138@itv");
            if(SystemProperties.get("persist.sys.cdn.type","").equals("zte")||SystemProperties.get("ro.ysten.province","master").equals("cm201_yunnan")||
                  SystemProperties.get("ro.ysten.province","master").equals("c60_yunnan")) {
            //begin: add by ysten zengzhiliang at 20180927:ntp server
            loadSetting(stmt, Settings.Secure.NTP_SERVER, "ztetime.otvtms.yn.chinamobile.com");
			loadSetting(stmt, Settings.Secure.NTP_SERVER2, "ztetime.otvtms.yn.chinamobile.com");
            }else{
            loadSetting(stmt, Settings.Secure.NTP_SERVER, "hwtime.otvtms.yn.chinamobile.com");
            loadSetting(stmt, Settings.Secure.NTP_SERVER2, "hwtime.otvtms.yn.chinamobile.com");
            }
            //end: add by ysten zengzhiliang at 20180927:ntp server

      }

			if(SystemProperties.get("ro.ysten.province","master").equals("c60_sichuan")){
			    /*for sichuan add by lizheng*/
			    loadSetting(stmt, Settings.Secure.NTP_SERVER, "223.87.20.100");
			    loadSetting(stmt, Settings.Secure.NTP_SERVER2, "223.87.4.66");
				// add by YSTen for IPOE {{

            String mac = SettingsTools.getEthMac();
            if(mac == null) {
                mac = "";
            }
            loadSetting(stmt, Settings.Secure.OPTION60_LOGIN, mac);

            loadStringSetting(stmt, Settings.Secure.OPTION60_PASSWORD,
                    R.string.def_ipoe_password);
// add by YSTen for IPOE }}
            }


            if("shcmcc".equals(SystemProperties.get("ro.product.target"))){
                loadSecureSettingsForSHYD(stmt);
            }
        } finally {
            if (stmt != null) stmt.close();
        }
    ...
    private void loadGlobalSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            if (SystemProperties.get("ro.ysten.province","master").equals("cm201_beijing")){
                loadSetting(stmt, Settings.Global.BLUETOOTH_ON,1);
            }else{
    ...
    private void loadSetting(SQLiteStatement stmt, String key, Object value) {
        ...
        if(SystemProperties.get("ro.ysten.province","master").contains("jidi")){
            if(key.equals("dhcp_user"))
                stmt.bindString(2, readSerialnoFromHis());
            else if(key.equals("dhcp_pswd"))
                stmt.bindString(2, "123456");
            else
    ...
    private String getDefaultDeviceName() {
        ...
        if (length > 4) {
            id = id.substring(length - 4);
        }
        StringBuffer devicename;

		if (SystemProperties.get("ro.ysten.province","master").equals("cm201_beijing")){
		devicename = new StringBuffer("魔百和");
		String typemac = SystemProperties.get("persist.sys.sjos.ethmac.value","");
		devicename.append(typemac);
		}
		else
		{
		 devicename = new StringBuffer();
         devicename.append(DEFAULT_DEVICE_NAME).append("_").append(id);
         }
