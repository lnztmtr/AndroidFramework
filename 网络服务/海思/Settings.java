...
public final class Settings {
	...
	// -- qb
    /**
     * @hide - Private call() method on SettingsProvider to refresh database..
     */
    public static final String CALL_METHOD_REFRESH = "SETTINGS_refresh";
    /**
     * @hide - Private call() method on SettingsProvider to stop database..
     */
    public static final String CALL_METHOD_STOP = "SETTINGS_stop";
	// -- qb
    ...
    public static final class System extends NameValueTable {
        ...
        static {
            ...
            MOVED_TO_SECURE.add(Secure.WIFI_OPTION60_ON);
            MOVED_TO_SECURE.add(Secure.WIFI_OPTION60_LOGIN);
            MOVED_TO_SECURE.add(Secure.WIFI_OPTION60_PASSWORD);
            MOVED_TO_SECURE.add(Secure.WIFI_OPTION125_ON);
            MOVED_TO_SECURE.add(Secure.WIFI_OPTION125_INFO);
            MOVED_TO_SECURE.add(Secure.WIFI_IPV6_OPTION60_ON);
            MOVED_TO_SECURE.add(Secure.WIFI_IPV6_OPTION60_LOGIN);
            MOVED_TO_SECURE.add(Secure.WIFI_IPV6_OPTION60_PASSWORD);
            MOVED_TO_SECURE.add(Secure.WIFI_IPV6_OPTION125_ON);
            MOVED_TO_SECURE.add(Secure.WIFI_IPV6_OPTION125_INFO);
            MOVED_TO_SECURE.add(Secure.ETHERNET_ON);
            MOVED_TO_SECURE.add(Secure.ETHERNET_MODE);
            MOVED_TO_SECURE.add(Secure.ETHERNET_IP);
            MOVED_TO_SECURE.add(Secure.ETHERNET_PREFIXLENGTH);
            MOVED_TO_SECURE.add(Secure.ETHERNET_DNS_1);
            MOVED_TO_SECURE.add(Secure.ETHERNET_DNS_2);
            MOVED_TO_SECURE.add(Secure.ETHERNET_ROUTE);
            MOVED_TO_SECURE.add(Secure.ETHERNET_IFNAME);
            MOVED_TO_SECURE.add(Secure.ETHERNET_AUTORECONNECT);
            MOVED_TO_SECURE.add(Secure.ETHERNET_DOUBLEVLAN);
            MOVED_TO_SECURE.add(Secure.OPTION60_ON);
            MOVED_TO_SECURE.add(Secure.OPTION60_LOGIN);
            MOVED_TO_SECURE.add(Secure.OPTION60_PASSWORD);
            MOVED_TO_SECURE.add(Secure.OPTION125_ON);
            MOVED_TO_SECURE.add(Secure.OPTION125_INFO);
            MOVED_TO_SECURE.add(Secure.WIFI_DISGUISE);
            MOVED_TO_SECURE.add(Secure.PPPOE_USER_NAME);
            MOVED_TO_SECURE.add(Secure.PPPOE_USER_PASS);
            MOVED_TO_SECURE.add(Secure.PPPOE_MODE);
            MOVED_TO_SECURE.add(Secure.WIFI_ETHERNET_COEXIST);
            MOVED_TO_SECURE.add(Secure.IPV6_ON);
            MOVED_TO_SECURE.add(Secure.ETHERNET_IPV6_MODE);
            MOVED_TO_SECURE.add(Secure.ETHERNET_IPV6_IP);
            MOVED_TO_SECURE.add(Secure.ETHERNET_IPV6_PREFIXLENGTH);
            MOVED_TO_SECURE.add(Secure.ETHERNET_IPV6_DNS_1);
            MOVED_TO_SECURE.add(Secure.ETHERNET_IPV6_DNS_2);
            MOVED_TO_SECURE.add(Secure.ETHERNET_IPV6_ROUTE);
            MOVED_TO_SECURE.add(Secure.ETHERNET_PPPOE_IPV6_STATELESS);
	    MOVED_TO_SECURE.add(Secure.ETHERNET_IPV6_MO_VALID);
            MOVED_TO_SECURE.add(Secure.WIFI_IPV6_IP);
            MOVED_TO_SECURE.add(Secure.WIFI_IPV6_PREFIXLENGTH);
            MOVED_TO_SECURE.add(Secure.WIFI_IPV6_ROUTE);
            MOVED_TO_SECURE.add(Secure.WIFI_IPV6_DNS_1);
            MOVED_TO_SECURE.add(Secure.WIFI_IPV6_DNS_2);
            MOVED_TO_SECURE.add(Secure.G3_USER_NAME);
            MOVED_TO_SECURE.add(Secure.G3_USER_PASS);
            MOVED_TO_SECURE.add(Secure.G3_APN_NAME);
            MOVED_TO_SECURE.add(Secure.G3_DIAL_NUMBER);
            MOVED_TO_SECURE.add(Secure.G3_PIN_CODE);
            MOVED_TO_SECURE.add(Secure.G3_ON);
            MOVED_TO_SECURE.add(Secure.G3_AUTORECONNECT);
            MOVED_TO_SECURE.add(Secure.G3_CONNECT_MODE);
            MOVED_TO_SECURE.add(Secure.HI_ETHERNET_ON);
            MOVED_TO_SECURE.add(Secure.HI_ETHERNET_MODE);
            MOVED_TO_SECURE.add(Secure.HI_ETHERNET_IP);
            MOVED_TO_SECURE.add(Secure.HI_ETHERNET_PREFIXLENGTH);
            MOVED_TO_SECURE.add(Secure.HI_ETHERNET_DNS_1);
            MOVED_TO_SECURE.add(Secure.HI_ETHERNET_DNS_2);
            MOVED_TO_SECURE.add(Secure.HI_ETHERNET_ROUTE);
            MOVED_TO_SECURE.add(Secure.HI_ETHERNET_IFNAME);
            MOVED_TO_SECURE.add(Secure.HI_ETHERNET_AUTORECONNECT);
            MOVED_TO_SECURE.add(Secure.HI_OPTION60_ON);
            MOVED_TO_SECURE.add(Secure.HI_OPTION60_LOGIN);
            MOVED_TO_SECURE.add(Secure.HI_OPTION60_PASSWORD);
            MOVED_TO_SECURE.add(Secure.HI_OPTION125_ON);
            MOVED_TO_SECURE.add(Secure.HI_OPTION125_INFO);
            MOVED_TO_SECURE.add(Secure.HI_IPV6_ON);
            MOVED_TO_SECURE.add(Secure.HI_ETHERNET_IPV6_MODE);
            MOVED_TO_SECURE.add(Secure.HI_ETHERNET_IPV6_IP);
            MOVED_TO_SECURE.add(Secure.HI_ETHERNET_IPV6_PREFIXLENGTH);
            MOVED_TO_SECURE.add(Secure.HI_ETHERNET_IPV6_DNS_1);
            MOVED_TO_SECURE.add(Secure.HI_ETHERNET_IPV6_DNS_2);
            MOVED_TO_SECURE.add(Secure.HI_ETHERNET_IPV6_ROUTE);
        }
        ...
        /** @hide */
        public static void refreshNameValueCache() {
            sNameValueCache.setRefreshFlag();
        }
        ...
        public static boolean putInt(ContentResolver cr, String name, int value) {
            ...
            Log.w(TAG, "Setting : " + value);
            //begin:add by xumiao at 20190328:sync persist and DB  go to sleep time setting
            if(("liaoning".contains(SystemProperties.get("ro.ysten.province"))) &&
                name.equals(SYSTEM_SLEEP_TIME_DELAY)){
                Log.w(TAG, "Setting : " + Integer.toString(value));
                SystemProperties.set("persist.sys.sleep",Integer.toString(value));
            }
            //end:add by xumiao at 20190328:sync persist and DB  go to sleep time setting
        ...
        public static boolean putLong(ContentResolver cr, String name, long value) {
            Log.w(TAG, "Setting putLong: " + name);
            Log.w(TAG, "Setting putLong: " + value);
            //begin:add by xumiao at 20190328:sync persist and DB  go to sleep time setting
            if(("liaoning".contains(SystemProperties.get("ro.ysten.province"))) &&
                name.equals(SYSTEM_SLEEP_TIME_DELAY)){
                Log.w(TAG, "Setting putLong: " + Long.toString(value));
                SystemProperties.set("persist.sys.sleep",Long.toString(value));
            }
            //end:add by xumiao at 20190328:sync persist and DB  go to sleep time setting
        ...
        public static final String SYSTEM_SLEEP_TIME_DELAY = "system_sleep_time_delay";
        ...
        /**
         * @deprecated Use {@link android.provider.Settings.Secure#ETHERNET_ON} instead
         */
        @Deprecated
        public static final String ETHERNET_ON = Secure.ETHERNET_ON;

        /**
         * @deprecated Use {@link android.provider.Settings.Secure#ETHERNET_MODE} instead
         */
        @Deprecated
        public static final String ETHERNET_MODE = Secure.ETHERNET_MODE;

        /**
         * @deprecated Use {@link android.provider.Settings.Secure#ETHERNET_IP} instead
         */
        @Deprecated
        public static final String ETHERNET_IP = Secure.ETHERNET_IP;

        /**
         * @deprecated Use {@link android.provider.Settings.Secure#ETHERNET_PREFIXLENGTH} instead
         */
        @Deprecated
        public static final String ETHERNET_PREFIXLENGTH = Secure.ETHERNET_PREFIXLENGTH;

        /**
         * @deprecated Use {@link android.provider.Settings.Secure#ETHERNET_DNS_1} instead
         */
        @Deprecated
        public static final String ETHERNET_DNS_1 = Secure.ETHERNET_DNS_1;

        /**
         * @deprecated Use {@link android.provider.Settings.Secure#ETHERNET_DNS_2} instead
         */
        @Deprecated
        public static final String ETHERNET_DNS_2 = Secure.ETHERNET_DNS_2;

        /**
         * @deprecated Use {@link android.provider.Settings.Secure#ETHERNET_ROUTE} instead
         */
        @Deprecated
        public static final String ETHERNET_ROUTE = Secure.ETHERNET_ROUTE;

        /**
         * @deprecated Use {@link android.provider.Settings.Secure#ETHERNET_IFNAME} instead
         */
        @Deprecated
        public static final String ETHERNET_IFNAME = Secure.ETHERNET_IFNAME;

        /**
         * @deprecated Use {@link android.provider.Settings.Secure#ETHERNET_AUTORECONNECT} instead
         */
        public static final String ETHERNET_AUTORECONNECT= Secure.ETHERNET_AUTORECONNECT;

        /**
         * @deprecated Use {@link android.provider.Settings.Secure#OPTION60_ON} instead
         */
        @Deprecated
        public static final String OPTION60_ON = Secure.OPTION60_ON;

        /**
         * @deprecated Use {@link android.provider.Settings.Secure#OPTION60_LOGIN} instead
         */
        @Deprecated
        public static final String OPTION60_LOGIN = Secure.OPTION60_LOGIN;

        /**
         * @deprecated Use {@link android.provider.Settings.Secure#OPTION60_PASSWORD} instead
         */
        @Deprecated
        public static final String OPTION60_PASSWORD = Secure.OPTION60_PASSWORD;

        /**
         * @deprecated Use {@link android.provider.Settings.Secure#OPTION125_ON} instead
         */
        @Deprecated
        public static final String OPTION125_ON = Secure.OPTION125_ON;

        /**
         * @deprecated Use {@link android.provider.Settings.Secure#OPTION125_INFO} instead
         */
        @Deprecated
        public static final String OPTION125_INFO = Secure.OPTION125_INFO;


        /**
         * @deprecated Use {@link android.provider.Settings.Secure#WIFI_DISGUISE} instead
         */
        @Deprecated
        public static final String WIFI_DISGUISE = Secure.WIFI_DISGUISE;

        /**
         * @deprecated Use {@link android.provider.Settings.Secure#PPPOE_USER_NAME} instead
         */
        public static final String PPPOE_USER_NAME = Secure.PPPOE_USER_NAME;

        /**
         * @deprecated Use {@link android.provider.Settings.Secure#PPPOE_USER_PASS} instead
         */
        public static final String PPPOE_USER_PASS = Secure.PPPOE_USER_PASS;

        /**
         * @deprecated Use {@link android.provider.Settings.Secure#PPPOE_MODE} instead
         */
        public static final String PPPOE_MODE = Secure.PPPOE_MODE;

        /**
         * @deprecated Use {@link android.provider.Settings.Secure#G3_USER_NAME} instead
         */
        public static final String G3_USER_NAME = Secure.G3_USER_NAME;

        /**
         * @deprecated Use {@link android.provider.Settings.Secure#G3_USER_PASS} instead
         */
        public static final String G3_USER_PASS = Secure.G3_USER_PASS;

        /**
         * @deprecated Use {@link android.provider.Settings.Secure#G3_ON} instead
         */

        /**
         *@deprecated Use {@link android.provider.Settings.Secure#G3_APN_NAME} instead
         *@deprecated Use {@link android.provider.Settings.Secure#G3_DIAL_NUMBER} instead
         *@deprecated Use {@link android.provider.Settings.Secure#G3_PIN_CODE} instead
         *@deprecated Use {@link android.provider.Settings.Secure#G3_CONNECT_MODE} instead
         */
        public static final String G3_APN_NAME = Secure.G3_APN_NAME;

        public static final String G3_DIAL_NUMBER = Secure.G3_DIAL_NUMBER;

        public static final String G3_PIN_CODE = Secure.G3_PIN_CODE;

        public static final String G3_CONNECT_MODE = Secure.G3_CONNECT_MODE;

        /**
         * @deprecated Use {@link android.provider.Settings.Secure#G3_AUTORECONNECT} instead
         */
        public static final String G3_AUTORECONNECT= Secure.G3_AUTORECONNECT;

        /**
         * @deprecated Use {@link android.provider.Settings.Secure#WIFI_ETHERNET_COEXIST} instead
         */
        public static final String WIFI_ETHERNET_COEXIST = Secure.WIFI_ETHERNET_COEXIST;

        /**
         * @deprecated Use {@link android.provider.Settings.Secure#IPV6_ON} instead
         */
        public static final String IPV6_ON = Secure.IPV6_ON;

        /**
         * @deprecated Use {@link android.provider.Settings.Secure#ETHERNET_IPV6_MODE} instead
         */
        public static final String ETHERNET_IPV6_MODE = Secure.ETHERNET_IPV6_MODE;

        /**
         * @deprecated Use {@link android.provider.Settings.Secure#ETHERNET_IPV6_IP} instead
         */
        @Deprecated
        public static final String ETHERNET_IPV6_IP = Secure.ETHERNET_IPV6_IP;

        /**
         * @deprecated Use {@link android.provider.Settings.Secure#ETHERNET_IPV6_PREFIXLENGTH} instead
         */
        @Deprecated
        public static final String ETHERNET_IPV6_PREFIXLENGTH = Secure.ETHERNET_IPV6_PREFIXLENGTH;

        /**
         * @deprecated Use {@link android.provider.Settings.Secure#ETHERNET_IPV6_DNS_1} instead
         */
        @Deprecated
        public static final String ETHERNET_IPV6_DNS_1 = Secure.ETHERNET_IPV6_DNS_1;

        /**
         * @deprecated Use {@link android.provider.Settings.Secure#ETHERNET_IPV6_DNS_2} instead
         */
        @Deprecated
        public static final String ETHERNET_IPV6_DNS_2 = Secure.ETHERNET_IPV6_DNS_2;

        /**
         * @deprecated Use {@link android.provider.Settings.Secure#ETHERNET_IPV6_ROUTE} instead
         */
        @Deprecated
        public static final String ETHERNET_IPV6_ROUTE = Secure.ETHERNET_IPV6_ROUTE;

        /**
         * @deprecated Use {@link android.provider.Settings.Secure#ETHERNET_PPPOE_IPV6_STATELESS} instead
         */
        @Deprecated
        public static final String ETHERNET_PPPOE_IPV6_STATELESS = Secure.ETHERNET_PPPOE_IPV6_STATELESS;

        /**
         * @deprecated Use {@link android.provider.Settings.Secure#WIFI_IPV6_IP} instead
         */
        @Deprecated
        public static final String WIFI_IPV6_IP = Secure.WIFI_IPV6_IP;

        /**
         * @deprecated Use {@link android.provider.Settings.Secure#WIFI_IPV6_PREFIXLENGTH} instead
         */
        @Deprecated
        public static final String WIFI_IPV6_PREFIXLENGTH = Secure.WIFI_IPV6_PREFIXLENGTH;

        /**
         * @deprecated Use {@link android.provider.Settings.Secure#WIFI_IPV6_ROUTE} instead
         */
        @Deprecated
        public static final String WIFI_IPV6_ROUTE = Secure.WIFI_IPV6_ROUTE;

        /**
         * @deprecated Use {@link android.provider.Settings.Secure#WIFI_IPV6_DNS_1} instead
         */
        @Deprecated
        public static final String WIFI_IPV6_DNS_1 = Secure.WIFI_IPV6_DNS_1;

        /**
         * @deprecated Use {@link android.provider.Settings.Secure#WIFI_IPV6_DNS_2} instead
         */
        @Deprecated
        public static final String WIFI_IPV6_DNS_2 = Secure.WIFI_IPV6_DNS_2;
       ...
       /**
        ...
        /**
         * @deprecated Use {@link android.provider.Settings.Global#WIFIAP_ON} instead
         */
        @Deprecated
        ...
        @Deprecated
        public static final String WIFI_OPTION60_ON = Secure.WIFI_OPTION60_ON;
        @Deprecated
        public static final String WIFI_OPTION60_LOGIN = Secure.WIFI_OPTION60_LOGIN;
        @Deprecated
        public static final String WIFI_OPTION60_PASSWORD = Secure.WIFI_OPTION60_PASSWORD;
        @Deprecated
        public static final String WIFI_OPTION125_ON = Secure.WIFI_OPTION125_ON;
        @Deprecated
        public static final String WIFI_OPTION125_INFO = Secure.WIFI_OPTION125_INFO;
		//add by guangchao.su
		public static final String SETTINGS_LOCK_PASSWORD = "settings_lock_password";
        
        @Deprecated
        public static final String WIFI_IPV6_OPTION60_ON = Secure.WIFI_IPV6_OPTION60_ON;
        @Deprecated
        public static final String WIFI_IPV6_OPTION60_LOGIN = Secure.WIFI_IPV6_OPTION60_LOGIN;
        @Deprecated
        public static final String WIFI_IPV6_OPTION60_PASSWORD = Secure.WIFI_IPV6_OPTION60_PASSWORD;
        @Deprecated
        public static final String WIFI_IPV6_OPTION125_ON = Secure.WIFI_IPV6_OPTION125_ON;
        @Deprecated
        public static final String WIFI_IPV6_OPTION125_INFO = Secure.WIFI_IPV6_OPTION125_INFO;

        @Deprecated
        public static final String HI_ETHERNET_ON = Secure.HI_ETHERNET_ON;
        @Deprecated
        public static final String HI_ETHERNET_MODE = Secure.HI_ETHERNET_MODE;
        @Deprecated
        public static final String HI_ETHERNET_IP = Secure.HI_ETHERNET_IP;
        @Deprecated
        public static final String HI_ETHERNET_PREFIXLENGTH = Secure.HI_ETHERNET_PREFIXLENGTH;
        @Deprecated
        public static final String HI_ETHERNET_DNS_1 = Secure.HI_ETHERNET_DNS_1;
        @Deprecated
        public static final String HI_ETHERNET_DNS_2 = Secure.HI_ETHERNET_DNS_2;
        @Deprecated
        public static final String HI_ETHERNET_ROUTE = Secure.HI_ETHERNET_ROUTE;
        @Deprecated
        public static final String HI_ETHERNET_IFNAME = Secure.HI_ETHERNET_IFNAME;
        public static final String HI_ETHERNET_AUTORECONNECT = Secure.HI_ETHERNET_AUTORECONNECT;
        @Deprecated
        public static final String HI_OPTION60_ON = Secure.HI_OPTION60_ON;
        @Deprecated
        public static final String HI_OPTION60_LOGIN = Secure.HI_OPTION60_LOGIN;
        @Deprecated
        public static final String HI_OPTION60_PASSWORD = Secure.HI_OPTION60_PASSWORD;
        @Deprecated
        public static final String HI_OPTION125_ON = Secure.HI_OPTION125_ON;
        @Deprecated
        public static final String HI_OPTION125_INFO = Secure.HI_OPTION125_INFO;
        @Deprecated
        public static final String HI_IPV6_ON = Secure.HI_IPV6_ON;
        @Deprecated
        public static final String HI_ETHERNET_IPV6_MODE = Secure.HI_ETHERNET_IPV6_MODE;
        @Deprecated
        public static final String HI_ETHERNET_IPV6_IP = Secure.HI_ETHERNET_IPV6_IP;
        @Deprecated
        public static final String HI_ETHERNET_IPV6_PREFIXLENGTH = Secure.HI_ETHERNET_IPV6_PREFIXLENGTH;
        @Deprecated
        public static final String HI_ETHERNET_IPV6_DNS_1 = Secure.HI_ETHERNET_IPV6_DNS_1;
        @Deprecated
        public static final String HI_ETHERNET_IPV6_DNS_2 = Secure.HI_ETHERNET_IPV6_DNS_2;
        @Deprecated
        public static final String HI_ETHERNET_IPV6_ROUTE = Secure.HI_ETHERNET_IPV6_ROUTE;
        @Deprecated
        public static final String ETHERNET_DOUBLEVLAN = Secure.ETHERNET_DOUBLEVLAN;
        @Deprecated
        public static final String ETHERNET_IPV6_MO_VALID = Secure.ETHERNET_IPV6_MO_VALID;
    }
	...
	//begin: add by ysten zongzy:add key
        public static final String ETH_DHCP_OPTION        = "eth_dhcp_option";
	public static final String PWDPROTECTED ="device.cmcc.diagnose.pwdprotected";
	//end: add by ysten zongzy
        ...
        public static final String SPDIF_PASSTHROUGH      = "spdif_passthrough";
        public static final String HDMI_PASSTHROUGH       = "hdmi_passthrough";
        public static final String INSATLL_NON_MARKET_APPS  = "install_non_market_apps";
        public static final String CEC_TV_TO_STB          = "cec_tv_to_stb";
        public static final String CEC_STB_TO_TV          = "cec_stb_to_tv";
        public static final String CMCC_WIFI_DISABLED     = "cmcc_wifi_disabled";
        public static final String SCREEN_SAVER_TIMEOUT   = "screen_saver_time";
        public static final String APK_CHECK_URL          = "apk_check_url";
        public static final String DEFAULT_NETWORK_PRIORITY   = "default_network_priority";
        public static final String CMCC_BLUETOOTH_DISABLED     = "cmcc_bluetooth_disabled";
        public static final String DLNA_ENABLE            = "dlna_enable";
        public static final String DIAGNOSE_PWDPROTECTED  = "diagnose_pwdprotected";
        ...
        static {
            ...
            //add by zhanghk at 1223:not move NTP_SERVER to Global
        ...
        public static boolean putStringForUser(ContentResolver resolver, String name, String value,
            ...
            if(SystemProperties.get("ro.ysten.province","master").contains("jidi")){
    	       if("dhcp_user".equals(name)||"dhcp_pswd".equals(name)){
    		      if("com.chinamobile.middleware.guide".equals(resolver.getPackageName())){
    			     Log.d(TAG,"do not allow bestAPK modify dhcp info");
    			     return false;
    		      }
    	       }
			   if( "cmcc_wifi_disabled".equals(name) && "1".equals(value)){
        ...
        public static final String WIFI_OPTION60_ON      = "wifi_option60_on";
        public static final String WIFI_OPTION60_LOGIN      = "wifi_option60_login";
        public static final String WIFI_OPTION60_PASSWORD      = "wifi_option60_password";
        public static final String WIFI_OPTION125_ON      = "wifi_option125_on";
        public static final String WIFI_OPTION125_INFO      = "wifi_option125_info";

        public static final String WIFI_IPV6_OPTION60_ON      = "wifi_ipv6_option60_on";
        public static final String WIFI_IPV6_OPTION60_LOGIN      = "wifi_ipv6_option60_login";
        public static final String WIFI_IPV6_OPTION60_PASSWORD      = "wifi_ipv6_option60_password";
        public static final String WIFI_IPV6_OPTION125_ON      = "wifi_ipv6_option125_on";
        public static final String WIFI_IPV6_OPTION125_INFO      = "wifi_ipv6_option125_info";
        ...
        /**
         * If Ethernet Obtains IP mode, DHCP or static(Manual).
         */
        public static final String ETHERNET_MODE    = "ethernet_mode";

        /**
         * If Ethernet Using static IP, The static IP address.
         * <p>
         * Example: "192.168.1.51"
         */
        ...
        /**
         * If Ethernet Using static IP, The Net Mask.
         * <p>
         * Example: "255.255.254.0"
         */
        public static final String ETHERNET_PREFIXLENGTH    = "ethernet_prefixlength";

        /**
         * If Ethernet Using static IP, The DNS1 address.
         * <p>
         * Example: "192.168.1.1"
         */
        public static final String ETHERNET_DNS_1     = "ethernet_dns1";

        /**
         * If Ethernet Using static IP, The DNS2 address.
         * <p>
         * Example: "192.168.1.1"
         */
        public static final String ETHERNET_DNS_2     = "ethernet_dns2";

        /**
         * If Ethernet Using static IP, The Route address.
         * <p>
         * Example: "192.168.1.1"
         */
        ...
        /**
         * Whether the Ethernet should be reconnected automatically.  Only the Ethernet service should touch this.
         */
        public static final String ETHERNET_AUTORECONNECT = "ethernet_autoreconnect";

        /**
         * Whether the dhcp option 60 should be on.  Only the ETHERNET service should touch this.
         */
        public static final String OPTION60_ON      = "option60_on";

        /**
         * if DHCP Using option 60, The String or the dhcp+ login.  Only the ETHERNET service should touch this.
         */
        public static final String OPTION60_LOGIN      = "option60_login";

        /**
         * if DHCP Using dhcp+, The dhcp+ password.  Only the ETHERNET service should touch this.
         */
        public static final String OPTION60_PASSWORD      = "option60_password";

        /**
         * Whether the dhcp option 125 should be on.  Only the ETHERNET service should touch this.
         */
        public static final String OPTION125_ON      = "option125_on";

        /**
         * if DHCP Using option 125, The option125 Vendor Specific Info.  Only the ETHERNET service should touch this.
         */
        public static final String OPTION125_INFO      = "option125_info";

        public static final String HI_ETHERNET_ON = "hi_ethernet_on";
        public static final String HI_ETHERNET_MODE = "hi_ethernet_mode";
        public static final String HI_ETHERNET_IP = "hi_ethernet_ip";
        public static final String HI_ETHERNET_PREFIXLENGTH = "hi_ethernet_prefixlength";
        public static final String HI_ETHERNET_DNS_1 = "hi_ethernet_dns1";
        public static final String HI_ETHERNET_DNS_2 = "hi_ethernet_dns2";
        public static final String HI_ETHERNET_ROUTE = "hi_ethernet_iproute";
        public static final String HI_ETHERNET_IFNAME = "hi_ethernet_ifname";
        public static final String HI_ETHERNET_AUTORECONNECT = "hi_ethernet_autoreconnect";
        public static final String HI_OPTION60_ON = "hi_option60_on";
        public static final String HI_OPTION60_LOGIN = "hi_option60_login";
        public static final String HI_OPTION60_PASSWORD = "hi_option60_password";
        public static final String HI_OPTION125_ON = "hi_option125_on";
        public static final String HI_OPTION125_INFO = "hi_option125_info";
        public static final String HI_IPV6_ON = "hi_ipv6_on";
        public static final String HI_ETHERNET_IPV6_MODE = "hi_ethernet_ipv6_mode";
        public static final String HI_ETHERNET_IPV6_IP = "hi_ethernet_ipv6_ip";
        public static final String HI_ETHERNET_IPV6_PREFIXLENGTH = "hi_ethernet_ipv6_prefixlength";
        public static final String HI_ETHERNET_IPV6_DNS_1 = "hi_ethernet_ipv6_dns_1";
        public static final String HI_ETHERNET_IPV6_DNS_2 = "hi_ethernet_ipv6_dns_2";
        public static final String HI_ETHERNET_IPV6_ROUTE = "hi_ethernet_ipv6_route";
        public static final String ETHERNET_DOUBLEVLAN = "ethernet_doublevlan";

        /**
         * Whether the ETHERNET should be disguise as WIFI.  Only the ETHERNET service should touch this.
         */
        public static final String WIFI_DISGUISE = "wifi_disguise";
         ...
         * Example: 123456
         */
        public static final String PPPOE_USER_PASS = "pppoe_user_pass";

        /**
         * Whether the PPPOE should be on.  Only the PPPOE service should touch this.
         */
        public static final String PPPOE_MODE = "pppoe_mode";

        /**
         * G3 user name
         * Example: admin
         */
        public static final String G3_USER_NAME = "g3_user_name";

        /**
         * G3 user password
         * Example: 123456
         */
        public static final String G3_USER_PASS = "g3_user_pass";

        public static final String G3_APN_NAME = "g3_apn_name";

        public static final String G3_DIAL_NUMBER = "g3_dial_number";

        public static final String G3_PIN_CODE = "g3_pin_code";


        /**
         * Whether the G3 should be on.  Only the G3 service should touch this.
         */
        public static final String G3_ON = "g3_on";

        public static final String G3_CONNECT_MODE = "g3_connect_mode";
        /**
         * Whether the G3 should be reconnected automatically.  Only the G3 service should touch this.
         */
        public static final String G3_AUTORECONNECT = "g3_autoreconnect";
        /**
         * Whether the PPPOE should be reconnected automatically.  Only the PPPOE service should touch this.
         */

        /**
         * Whether the Wifi and Ethernet should coexist.  Only the Ethernet service should touch this.
         */
        public static final String WIFI_ETHERNET_COEXIST = "wifi_ethernet_coexist";

        /**
         * Whether the IPV4 should be on.  Only the Ethernet service should touch this.
         */
        public static final String IPV4_ON = "ipv4_on";

        /**
         * Whether the IPV6 should be on.  Only the Ethernet service should touch this.
         */
        public static final String IPV6_ON = "ipv6_on";

        /**
         * Whether the IPV6 should use dhcpv6 or static ip.  Only the Ethernet service should touch this.
         */
        public static final String ETHERNET_IPV6_MODE = "ethernet_ipv6_mode";

        /**
         * If Ethernet IPV6 Using static IP, The static IP address.
         * <p>
         * Example: "2001:da8:207::9401"
         */
        public static final String ETHERNET_IPV6_IP      = "ethernet_ipv6_ip";

        /**
         * If Ethernet IPV6 Using static IP, The PrefixLength
         * <p>
         * Example: 64
         */
        public static final String ETHERNET_IPV6_PREFIXLENGTH    = "ethernet_ipv6_prefixlength";

        /**
         * If Ethernet IPV6 Using static IP, The DNS1 address.
         * <p>
         * Example: "2001:da8:207::1"
         */
        public static final String ETHERNET_IPV6_DNS_1     = "ethernet_ipv6_dns1";

        /**
         * If Ethernet IPV6 Using static IP, The DNS2 address.
         * <p>
         * Example: "2001:da8:207::2"
         */
        public static final String ETHERNET_IPV6_DNS_2     = "ethernet_ipv6_dns2";

        /**
         * If Ethernet IPV6 Using static IP, The Route address.
         * <p>
         * Example: "2001:da8:207::1"
         */
        public static final String ETHERNET_IPV6_ROUTE   = "ethernet_ipv6_iproute";

        /**
         * If Ethernet PPPOE IPV6 Using statless IP.
         * <p>
         */
        public static final String ETHERNET_PPPOE_IPV6_STATELESS = "ethernet_pppoe_ipv6_stateless";

        /**
         * If Ethernet IPV6 auto change to stateless/statefull
         * <p>
         */
        public static final String ETHERNET_IPV6_MO_VALID = "ethernet_ipv6_mo_valid";

        /**
         * If WiFi IPV6 Using static IP, The static IP address.
         * <p>
         * Example: "2001:da8:207::9401"
         */
        public static final String WIFI_IPV6_IP      = "wifi_ipv6_ip";

        /**
         * If WiFi IPV6 Using static IP, The PrefixLength
         * <p>
         * Example: 64
         */
        public static final String WIFI_IPV6_PREFIXLENGTH    = "wifi_ipv6_prefixlength";

        /**
         * If WiFi IPV6 Using static IP, The Route address.
         * <p>
         * Example: "2001:da8:207::1"
         */
        public static final String WIFI_IPV6_ROUTE   = "wifi_ipv6_iproute";

        /**
         * If WiFi IPV6 Using static IP, The DNS1 address.
         * <p>
         * Example: "2001:da8:207::1"
         */
        public static final String WIFI_IPV6_DNS_1     = "wifi_ipv6_dns1";

        /**
         * If WiFi IPV6 Using static IP, The DNS2 address.
         * <p>
         * Example: "2001:da8:207::2"
         */
        public static final String WIFI_IPV6_DNS_2     = "wifi_ipv6_dns2";
    ...
    public static final class Global extends NameValueTable {
       ...
       /**
        * Whether the WiFi-AP should be on.  Only the Wi-Fi service should touch this.
        */
