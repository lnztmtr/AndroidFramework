...
public class ConnectivityManager {
    ...
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String ACTION_IP_ADDRESS_CONFLICTED =
            "android.net.conn.IP_ADDRESS_CONFLICTED";
    ...
    public static final int TYPE_VLAN = 16;
    public static final int TYPE_ETHERNET_IPV6 = 17;
    ...
    static {
        //if (SystemProperties.getBoolean("ro.platform.has.pppoe", false)) {
            MAX_RADIO_TYPE = TYPE_ETHERNET_IPV6;
            MAX_NETWORK_TYPE = TYPE_ETHERNET_IPV6;
        //} else {
     ...
     * @hide
     */
    public static final int CONNECTIVITY_CHANGE_DELAY_DEFAULT = 0;
    ...
    public int setWifiDhcpRange(String[] start_end_ip) {
        try {
            return mService.setWifiDhcpRange(start_end_ip);
        } catch (RemoteException e) {
            return TETHER_ERROR_IFACE_CFG_ERROR;
        }
    }

    public String[] getWifiDhcpRange() {
        try {
            return mService.getWifiDhcpRange();
        } catch (RemoteException e) {
            return null;
        }
    }
