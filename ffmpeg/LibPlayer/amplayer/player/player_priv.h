...
typedef struct play_para {
    ...
    pthread_t player_dec_reset_tid;
    pthread_t cache_reset_tid;
    pthread_t cache_release_tid;
    pthread_t decode_release_tid;
    pthread_t ffmpeg_close_tid;

    int player_dec_reset_status; // 0: ongoing, 1 :end ok, -1: err
    int player_cache_reset_status; //0, default,  1: ongoing, 2: end ok
    int player_cache_read_frame_end; //0, default, 1, end;
    ...
    */
    ...
    // avlist
    av_packet_cache_t avpkt_cache;
    int cmcc_report_enable;
